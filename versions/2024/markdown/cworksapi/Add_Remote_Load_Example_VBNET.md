---
title: "Add Remote Load Example (VB.NET)"
project: ""
interface: ""
member: ""
kind: "example"
source: "cworksapi/Add_Remote_Load_Example_VBNET.htm"
---

# Add Remote Load Example (VB.NET)
...
```vb
 ...
 Partial Class SolidWorksMacro
     ...
     Sub main()
         ...
         Dim CWContactMgr As CWContactManager
         ...
         Dim DispArray4(0) As Object
         Dim DispArray5(0) As Object
         Dim Disp As Object
         ...
         Study = StudyMngr.CreateNewStudy3("Static_Mixed6", swsAnalysisStudyType_e.swsAnalysisStudyTypeStatic, 0, errCode)
         ...
         Dim CWShellObj As CWShell
         CWShellObj = ShellMgr.GetShellAt(0, errCode)
         ...
         Call ShellMat.SetPropertyByName("EX", 120000000000.0#, 0)
         ...
         Dim CWRemoteLoad As CWRemoteLoad
         CWRemoteLoad = LBCMgr.AddRemoteLoad(0, (DispArray2), 0, 1.2, 1.5, 1.6, errCode)
         ...
         Dim bxvalue As Integer
         Dim dxvalue As Double
         Dim byvalue As Integer
         Dim dyvalue As Double
         Dim bzvalue As Integer
         ...
         Dim CWContactObj As CWContactSet
         CWContactMgr = Study.ContactManager
         CWContactObj = CWContactMgr.CreateContactSet(1, (DispArray4), (DispArray5), errCode)
         If errCode <> 0 Then ErrorMsg(swApp, "Failed to create CWContactSet object")
         CWContactObj = Nothing
         ...
         If errCode <> 0 Then ErrorMsg(SwApp, "Failed to get disp result")
         'Compare max resultant displacement with URESMax
