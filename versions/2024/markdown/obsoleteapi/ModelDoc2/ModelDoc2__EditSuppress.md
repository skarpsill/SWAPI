...
by[ModelDoc2::EditSuppress2](sldworksAPI.chm::/ModelDoc2/ModelDoc2__EditSuppress2.htm).
...
| Output: | (VARIANT_BOOL) retval | TRUE if suppressed, FALSE otherwise |
| --- | --- | --- |
...
<param name="_CURRENTFILEPATH" value="C:\Home\Oneill\sw2003\ModelDoc2\ModelDoc2__EditSuppress.htm" >
