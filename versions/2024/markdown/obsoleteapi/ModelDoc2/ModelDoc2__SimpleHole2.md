---
title: "ModelDoc2::SimpleHole2"
project: ""
interface: ""
member: ""
kind: "topic"
source: "obsoleteapi/ModelDoc2/ModelDoc2__SimpleHole2.htm"
---

# ModelDoc2::SimpleHole2

This method is obsolete and has been superseded
by[ModelDoc2::SimpleHole3](ModelDoc2__SimpleHole3.htm).
...
| Input: | (long) t1 | Termination type for first end as defined in the swEndConditions_e |
| Input: | (long) t2 | Termination type for second end as defined in the swEndConditions_e |
...
plane, then TRUE specifies offset
in direction away from the sketch, FALSE specifies offset from the face
or plane in a direction toward the sketch |

Syntax (COM)

status = ModelDoc2->SimpleHole2
...
<param name="_CURRENTFILEPATH" value="D:\APIHelp\sw2004\obsoleteapi\ModelDoc2\ModelDoc2__SimpleHole2.htm" >
