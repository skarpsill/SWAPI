---
title: "DisplayDimension::GetNext2"
project: ""
interface: ""
member: ""
kind: "topic"
...
retval | Pointer
to the next DisplayDimension object |
| --- | --- | --- |
| Return: | (HRESULT)
status | S_OK
if successful |
...
When a base ordinate is not visible, DisplayDimension::GetNextkadov_tag{{<spaces>}}kadov_tag{{</spaces>}}does
...
<param name="_CURRENTFILEPATH" value="D:\APIHelp\sw2004\obsoleteapi\DisplayDimension\DisplayDimension__GetNext2.htm" >
