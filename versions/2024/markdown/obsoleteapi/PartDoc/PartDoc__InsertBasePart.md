...
| --- | --- | --- |
| Output: | (VARIANT_BOOL) *retval | TRUE if the part was inserted, FALSE if not |
...
<param name="_CURRENTFILEPATH" value="C:\cheryle\APIHelp\sw2008\obsoleteapi\PartDoc\PartDoc__InsertBasePart.htm" >
