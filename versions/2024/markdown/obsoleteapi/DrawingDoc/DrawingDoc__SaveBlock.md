...
by[SketchBlockDefinition::Save](sldworksAPI.chm::/SketchBlockDefinition/SketchBlockDefinition__Save.htm).
...
| --- | --- | --- |
| Output: | (VARIANT_BOOL) retval | TRUE if the block is saved to the file, FALSE if not |
...
<param name="_CURRENTFILEPATH" value="C:\cheryle\APIHelp\sw2007\obsoleteapi\DrawingDoc\DrawingDoc__SaveBlock.htm" >
...
<param name="ControlLabel" value="See Also" >
<param name="UseIcon" value="0" >
<param name="Items" value="EXExportBlocksFiles$$**$$EXSaveBlockFile$$**$$" >
<param name="Image" value="" >
<param name="FontInfo" value="MS Sans Serif,8,0,," >
<param name="_CURRENTFILEPATH" value="C:\cheryle\APIHelp\sw2007\obsoleteapi\DrawingDoc\DrawingDoc__SaveBlock.htm" >
