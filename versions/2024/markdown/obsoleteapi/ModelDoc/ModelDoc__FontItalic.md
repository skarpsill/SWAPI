...
This
method is obsolete and has been superseded by[ModelDoc2::FontItalic](sldworksAPI.chm::/ModelDoc2/ModelDoc2__FontItalic.htm).
...
| Input: | (Boolean) italic | If TRUE, then Italic style is enabled, if FALSE,
...
| Input: | (VARIANT_BOOL) italic | If TRUE, then Italic style is enabled, if FALSE,
then Italic is disabled |
| --- | --- | --- |
...
<param name="_CURRENTFILEPATH" value="D:\APIHelp\sw2004\obsoleteapi\ModelDoc\ModelDoc__FontItalic.htm" >
