---
title: "ModelDoc::FeatureCirPattern"
project: ""
interface: ""
member: ""
kind: "topic"
...
| --- | --- | --- |
| Input: | (double) spacing | Spacing in radians |
| Input: | (VARIANT_BOOL) flipDir | TRUE if able to flip direction, FALSE to not |
| Input: | (BSTR) dName | Name of angular dimension defining the direction of the pattern |
...
<param name="Items" value="AssemblyDoc::InsertDerivedPattern$$**$$ModelDoc::FeatureLinearPattern$$**$$ModelDoc_Object$$**$$" >
<param name="Image" value="" >
<param name="FontInfo" value="MS Sans Serif,8,0,," >
<param name="_CURRENTFILEPATH" value="D:\APIHelp\sw2004\obsoleteapi\ModelDoc\ModelDoc__FeatureCirPattern.htm" >
