---
title: "ModelDoc::CreatePlaneAtOffset"
project: ""
interface: ""
member: ""
kind: "topic"
...
| --- | --- | --- |
| Input: | (BOOL) flipDir | TRUE to flip the offset direction for the resulting plane, FALSE to
not |
...
| Input: | (double) val | Offset distance from selected plane in meters |
| --- | --- | --- |
| Input: | (VARIANT_BOOL) flipDir | TRUE to flip the offset direction for the resulting plane, FALSE to
not |
...
<param name="_CURRENTFILEPATH" value="C:\Home\Oneill\ModelDoc\ModelDoc__CreatePlaneAtOffset.htm" >
