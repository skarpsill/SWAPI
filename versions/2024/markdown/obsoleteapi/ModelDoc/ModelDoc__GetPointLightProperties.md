---
title: "ModelDoc::GetPointLightProperties"
project: ""
interface: ""
member: ""
kind: "topic"
...
This
method is obsolete and has been superseded by[ModelDoc2::GetPointLightProperties](sldworksAPI.chm::/ModelDoc2/ModelDoc2__GetPointLightProperties.htm).
...
| Output: | (VARIANT_BOOL) fixed | TRUE if a light is fixed, FALSE if nto |
| Output: | (double) x | x location of the point light |
| Output: | (double) y | y location of the point light |
| Output: | (double) z | z location of the point light |
...
<param name="_CURRENTFILEPATH" value="C:\Home\Oneill\sw2003\ModelDoc\ModelDoc__GetPointLightProperties.htm" >
