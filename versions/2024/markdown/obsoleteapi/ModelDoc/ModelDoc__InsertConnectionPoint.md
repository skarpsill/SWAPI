---
title: "ModelDoc::InsertConnectionPoint"
project: ""
interface: ""
member: ""
kind: "topic"
...
This
method is obsolete and has been superseded by[ModelDoc2::InsertConnectionPoint](sldworksAPI.chm::/ModelDoc2/ModelDoc2__InsertConnectionPoint.htm).

Description

This method adds a connection point based on
the selected point and selected planar item. If the selection set is not
complete, then theInsert Connection
Pointdialog is displayed.
...
<param name="_CURRENTFILEPATH" value="C:\Home\Oneill\sw2003\ModelDoc\ModelDoc__InsertConnectionPoint.htm" >
