---
title: "View::GetDimensionDisplayInfo2"
project: ""
interface: ""
member: ""
kind: "topic"
source: "obsoleteapi/View/View__GetDimensionDisplayInfo2.htm"
---

# View::GetDimensionDisplayInfo2

This
method is obsolete and has been superseded by View::GetDimensionDisplayInfo3 .

Description

This method gets each dimension in the current drawing view in the form
of line, arc, and text data.

Syntax (OLE Automation)

retval = View.GetDimensionDisplayInfo2
()
...
status = View->IGetDimensionDisplayInfo2
( retval )
...
For COM implementation, call[View::GetDimensionCount2](View__GetDimensionCount2.htm)to determine the overall size of the array
needed. The maximum number of doubles contained in the array will be (dimensionCount* 173 + 1).
...
This method is identical to the now obsolete View::GetDimensionDisplayInfo
except when a base ordinate is not visible, the subordinates are not output,
regardless of whether they are visible or not. This method outputs of
each subordinate, if it is visible, regardless of whether or not its base
ordinate is visible.
...
<param name="_CURRENTFILEPATH" value="D:\APIHelp\sw2003\View\View__GetDimensionDisplayInfo2.htm" >
