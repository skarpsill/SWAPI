---
title: "ExtrudeFeatureData::IsThinFeature"
project: ""
interface: ""
member: ""
kind: "topic"
...
| Return: | (BOOL) isThinFeature | TRUE if extrusion is a thin feature, FALSE if
not |
| --- | --- | --- |

Syntax (COM)

status = ExtrudeFeatureData->get_IsThinFeature
( &isThinFeature )

(Table)=========================================================

| Output: | (VARIANT_BOOL) isThinFeature | TRUE if extrusion is a thin feature, FALSE if
not |
| --- | --- | --- |
...
<param name="_CURRENTFILEPATH" value="C:\Home\Oneill\sw2003\ExtrudeFeatureData\ExtrudeFeatureData__IsThinFeature.htm" >
