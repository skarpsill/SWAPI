---
title: "DraftFeatureData::ReverseDirection"
project: ""
interface: ""
member: ""
kind: "topic"
...
| Property: | (BOOL) reverseDirection | TRUE if the direction of the draft feature is
reversed, FALSE if it is not |
| --- | --- | --- |

Syntax (COM)

status = DraftFeatureData ->get_ReverseDirection
( &reverseDirection )

status = DraftFeatureData ->put_ReverseDirection
( reverseDirection )

(Table)=========================================================

| Property: | (VARIANT_BOOL) reverseDirection | TRUE if the direction of the draft feature is
reversed, FALSE if it is not |
| --- | --- | --- |
...
<param name="_CURRENTFILEPATH" value="C:\Home\Oneill\DraftFeatureData\DraftFeatureData__ReverseDirection.htm" >
