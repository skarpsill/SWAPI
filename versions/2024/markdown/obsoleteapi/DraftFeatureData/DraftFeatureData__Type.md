...
type= DraftFeatureData.GetType ( ) (C++ Get property)

(Table)=========================================================

| Property: | ( int ) type | Draft type: 0 = Neutral
Plane 1 = Parting Line |
| --- | --- | --- |

Syntax (COM)

status = DraftFeatureData ->get_Type ( &type)
...
<param name="_CURRENTFILEPATH" value="C:\Home\Oneill\DraftFeatureData\DraftFeatureData__Type.htm" >
