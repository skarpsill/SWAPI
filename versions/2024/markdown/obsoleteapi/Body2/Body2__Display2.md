...
by[Body2::Display3](sldworksAPI.chm::/Body2/Body2__Display3.htm).
...
| Input: | (long) option | Selection state of temporary
body as defined by swTempBodySelectOptions_e |
...
| Input: | (LPPARTDOC) part | Part document in which body exists |
| --- | --- | --- |
| Input: | (long) color | COLORREF value
for color |
| Input: | (long) option | Selection state of temporary
body as defined by swTempBodySelectOptions_e |
...
<param name="_CURRENTFILEPATH" value="C:\cheryle\APIHelp\sw2007\obsoleteapi\Body2\Body2__Display2.htm" >
...
<param name="ControlLabel" value="See Also" >
<param name="UseIcon" value="0" >
<param name="Items" value="CheckBodyEX$$**$$" >
<param name="Image" value="" >
<param name="FontInfo" value="MS Sans Serif,8,0,," >
<param name="_CURRENTFILEPATH" value="C:\cheryle\APIHelp\sw2007\obsoleteapi\Body2\Body2__Display2.htm" >
...
<param name="ControlLabel" value="See Also" >
<param name="UseIcon" value="0" >
<param name="Items" value="EXExtendSurface$$**$$EXMakeOffset$$**$$EXCreateConvertNonManifoldBodies$$**$$EXCreateTemporaryExtrudedBody$$**$$" >
<param name="Image" value="" >
<param name="FontInfo" value="MS Sans Serif,8,0,," >
<param name="_CURRENTFILEPATH" value="C:\cheryle\APIHelp\sw2007\obsoleteapi\Body2\Body2__Display2.htm" >
