...
inside of the SOLIDWORKS environment and as a standalone application.
...
This online reference manual documents the interfaces available in
the SOLIDWORKS PDM Professional API, including their structures, methods,
properties, and enumerations.

All of the sample code supplied is provided on an as-is basis and is
...
apply to the samples. Some sample code might contain obsolete APIs.
