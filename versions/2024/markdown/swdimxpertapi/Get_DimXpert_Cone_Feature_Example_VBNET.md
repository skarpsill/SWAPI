---
title: "Get DimXpert Cone Feature Example (VB.NET)"
project: ""
interface: ""
member: ""
kind: "example"
...
' of
the Management Panel:kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}Cone1.

'kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}7.
Open an Immediate window.

'kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}8.
Ensure that theSolidWorks.Interop.swdimxpert.dllinterop
...
kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}coneFeature
