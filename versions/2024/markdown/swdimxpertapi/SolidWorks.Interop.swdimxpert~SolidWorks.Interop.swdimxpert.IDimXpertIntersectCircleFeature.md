---
title: "IDimXpertIntersectCircleFeature Interface"
project: "SOLIDWORKS DimXpert API Help"
interface: "IDimXpertIntersectCircleFeature"
member: ""
kind: "interface"
source: "swdimxpertapi/SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertIntersectCircleFeature.html"
---

# IDimXpertIntersectCircleFeature Interface

Allows you to access specific information about DimXpert intersect circles on the DimXpertManager tab of the Management Panel.
...
```vb
Public Interface IDimXpertIntersectCircleFeature
```
...
```cpp
public interface class IDimXpertIntersectCircleFeature
```
...
[DimXpertIntersectCircleFeature](ms-its:swdimxpertapivb6.chm::/swdimxpert~DimXpertIntersectCircleFeature.html)
