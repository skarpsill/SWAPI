...
member: ""
kind: "example"
source: "swdimxpertapi/Get_DimXpert_Tolerance1_Example_VBNET.htm"
---
...
'----------------------------------------------------------------------------
' Preconditions:
' kadov_tag{{<spaces>}}1. Open public_documents\samples\tutorial\api\cover_with_geometric_tolerances.sldprt.
' kadov_tag{{<spaces>}}2. Click Geometric Tolerance the DimXpert toolbar.
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}In the Geometric Tolerance Properties dialog:
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}a. Select Cylindricity from the Symbol dropdown.
' kadov_tag{{<spaces>}}   b. In the second row, select Profile of Surface from the Symbol dropdown
'       and type a tolerance of 0.5 next to it.
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}c. Click the outer base cylinder and click again outside the part
'       to place the annotation.
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}d. Click OK to close the Geometric Tolerance Properties dialog.
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}3. In the DimXpertManager tab of the Management Panel,
'    expand all of the nodes in the tree.
' kadov_tag{{<spaces>}}4. Observe the following Dimxpert annotations: kadov_tag{{<spaces>}} kadov_tag{{</spaces>}}
'    Flatness1, Circularity1, Diameter1, CounterSinkAngle1,
'    CounterSinkDiameter1, Cylindricity1, and Surface Profile1
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}5. Ensure that the SolidWorks.Interop.swdimxpert.dll interop assembly is loaded
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}(right-click the project in Project Explorer and click on Add Reference >
'     NET tab).
' kadov_tag{{<spaces>}}6. Ensure that the Microsoft Scripting Runtime library is loaded
' kadov_tag{{<spaces>}}   (right-click the project in Project Explorer and click on Add Reference >
'    COM tab).
'
' Postconditions:
...
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}Dim csDiameter As IDimXpertCounterSinkDiameterDimTol
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}csDiameter = annotation
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}If csDiameter.ReferenceFeature Is Nothing Then
kadov_tag{{<spaces>}}                kadov_tag{{</spaces>}}strs.Add("Reference Feature: NULL")
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}Else
kadov_tag{{<spaces>}}                kadov_tag{{</spaces>}}strs.Add("Reference Feature: " + csDiameter.ReferenceFeature.Name)
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}End If
...
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}Dim csAngle As IDimXpertCounterSinkAngleDimTol
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}csAngle = annotation
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}isAngleType = True
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}If csAngle.ReferenceFeature Is Nothing Then
kadov_tag{{<spaces>}}                kadov_tag{{</spaces>}}strs.Add("Reference Feature: NULL")
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}Else
kadov_tag{{<spaces>}}                kadov_tag{{</spaces>}}strs.Add("Reference Feature: " + csAngle.ReferenceFeature.Name)
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}End If
