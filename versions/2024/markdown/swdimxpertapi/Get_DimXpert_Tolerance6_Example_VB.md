---
title: "Get DimXpert Tolerance6 Example (VBA)"
project: ""
interface: ""
member: ""
kind: "example"
source: "swdimxpertapi/Get_DimXpert_Tolerance6_Example_VB.htm"
---
...
```vb
 '----------------------------------------------------------------------------
' Preconditions:
'  1. kadov_tag{{<spaces>}}Open  public_documents\samples\tutorial\cosmosxpress\aw_anchor_plate.sldprt.
...
' kadov_tag{{<spaces>}} 1. Click Datum on the DimXpert tool bar.
'  kadov_tag{{<spaces>}}2. Click a top face of the part.
'  kadov_tag{{<spaces>}}3. Click to place Datum A.
'  kadov_tag{{<spaces>}}4. Click a back face of the part.
'  kadov_tag{{<spaces>}}5. Click to place Datum B.
'  kadov_tag{{<spaces>}}6. Click a side face of the part.
...
'  9. In the Geometric Tolerance Properties dialog:
' kadov_tag{{<spaces>}}    kadov_tag{{</spaces>}}a. Select Profile of Surface from the Symbol dropdown.
' kadov_tag{{<spaces>}}    kadov_tag{{</spaces>}}b. Type A in Primary, B in Secondary, and C
'        in Tertiary.
' kadov_tag{{<spaces>}}    kadov_tag{{</spaces>}}c. In the second row, select Profile of Surface in the Symbol dropdown.
' kadov_tag{{<spaces>}}    d. In the second row, type A in Primary .
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}} e. Select the Composite frame check box.
...
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}10. In the DimXpertManager tab of the Management Panel, expand Cylinder1.
' kadov_tag{{<spaces>}}11. Observe the following DimXpert annotation:kadov_tag{{<spaces>}} kadov_tag{{</spaces>}}Composite Surface Profile1
'
' Create tangency geometric tolerances:
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}} 1. Click Auto Dimension Scheme.
' kadov_tag{{<spaces>}} 2. Select all feature filters.
'  kadov_tag{{<spaces>}}3. Click the green check mark to accept the settings.
