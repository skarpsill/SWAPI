---
title: "Get DimXpert Tolerance3 Example (VBA)"
project: ""
interface: ""
member: ""
kind: "example"
source: "swdimxpertapi/Get_DimXpert_Tolerance3_Example_VB.htm"
---

# Get DimXpert Tolerance3 Example (VBA)
...
```vb
 '----------------------------------------------------------------------------
' Preconditions:
' 1. kadov_tag{{<spaces>}}Open public_documents\samples\tutorial\api\cover_position.sldprt.
' kadov_tag{{<spaces>}}2. Create a composite position tolerance:
...
' kadov_tag{{<spaces>}}      1. Select Position in Symbol.
' kadov_tag{{<spaces>}}      2. Type A in Primary, B in Secondary, and C in Tertiary.
' kadov_tag{{<spaces>}}      3. In second row (lower tier), select Position in Symbol.
' kadov_tag{{<spaces>}}      4. Type 0.25 in Tolerance 1.
' kadov_tag{{<spaces>}}      5. Type A in Primary.
' kadov_tag{{<spaces>}}      6. Select the Composite frame check box.
' kadov_tag{{<spaces>}}      kadov_tag{{</spaces>}} 7. Click the circular face of the boss.
...
' kadov_tag{{<spaces>}}3. In the DimXpertManager tab of the Management Panel, expand Plane2.
' 4. Observe this DimXpert annotation:kadov_tag{{<spaces>}} kadov_tag{{</spaces>}}CompositePosition1.
' kadov_tag{{<spaces>}}5. Ensure that the SOLIDWORKS DimXpert type library is loaded
'    in Tools > References.
