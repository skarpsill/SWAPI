...
member: ""
kind: "example"
source: "swdimxpertapi/Get_DimXpert_Tolerance2_Example_VBNET.htm"
---
...
' kadov_tag{{<spaces>}}1. Click Location Dimension on the DimXpert toolbar.
' kadov_tag{{<spaces>}}2. Click the left front face of the block.
' kadov_tag{{<spaces>}}3. Select Create Compound Plane from the DimXpert shortcut toolbar.
' kadov_tag{{<spaces>}}4. Click the right front face of the block.
' kadov_tag{{<spaces>}}5. Click the green check mark to accept the faces.
' kadov_tag{{<spaces>}}6. Click the back face of the block to complete the location dimension.
' kadov_tag{{<spaces>}}7. Click to position the location dimension.
' kadov_tag{{<spaces>}}8. Pres Esc to end dimensioning.
' kadov_tag{{<spaces>}}9. Observe the following DimXpert annotations: kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}DistanceBetween1

' Create composite distance-between and radius dimension tolerances:
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}1. Click Auto Dimension Scheme on the DimXpert toolbar.
' kadov_tag{{<spaces>}}2. Select Part type. kadov_tag{{<spaces>}} kadov_tag{{</spaces>}}
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}3. Select Tolerance type. kadov_tag{{<spaces>}}
' kadov_tag{{<spaces>}}4. For Primary Datum, select the face in front of right hole.
' kadov_tag{{<spaces>}}5. For Secondary Datum, select the top face of block.
' kadov_tag{{<spaces>}}6. Select all feature filters.
' kadov_tag{{<spaces>}}7. Click the green check mark to accept the DimXpert settings.
' kadov_tag{{<spaces>}}8. Observe the following DimXpert annotations: kadov_tag{{<spaces>}} kadov_tag{{</spaces>}}
'    Diameter1, DistanceBetween5, and Radius1

' Create a symmetry geometric tolerance:
' kadov_tag{{<spaces>}}1. Click Datum on the DimXpert toolbar.
' kadov_tag{{<spaces>}}2. Click the face in front of the left hole and click
'    to place Datum A.
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}3. Click the green check mark to finish the Datum definition.
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}4. Click Geometric Tolerance on the DimXpert toolbar.
' kadov_tag{{<spaces>}}   In the Geometric Tolerance Properties dialog:
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}a. Select Symmetry from the Symbol dropdown.
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}b. Type A for the Primary Datum.
' kadov_tag{{<spaces>}}   c. Click the face in front of the right hole.
' kadov_tag{{<spaces>}}   d. Click to place the annotation.
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}e. Click OK to close the Geometric Tolerance Properties dialog.
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}5. Observe the following DimXpert annotations: kadov_tag{{</spaces>}}Symmetry1
'
' Before running the macro:
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}1. Open the Immediate window.
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}2. Ensure that the SolidWorks.Interop.swdimxpert.dll interop
'    assembly is loaded (right-click the project in the Project
'    Explorer and click on Add Reference > .NET tab).
' kadov_tag{{<spaces>}}3. Ensure that the Microsoft Scripting Runtime library is loaded
' kadov_tag{{<spaces>}}   (right-click the project in the Project Explorer and click on Add Reference >
'    COM tab).
'
' Postconditions:
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}1. Writes the output to c:\temp\dimXpertInfo.txt.
...
kadov_tag{{<spaces>}} kadov_tag{{</spaces>}}Dim patternTreatment As swDimXpertPatternTreatmentType_e
...
ElseIf annoType = swDimXpertAnnotationType_e.swDimXpertDimTol_Radius Then
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}Dim radiusDim As IDimXpertRadiusDimTol
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}radiusDim = annotation
...
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}If patternTreatment = swDimXpertPatternTreatmentType_e.swDimXpertPatternTreatmentType_unknown Then
kadov_tag{{<spaces>}}                kadov_tag{{</spaces>}}strs.Add("Pattern Treatment: unknown")
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}ElseIf patternTreatment = swDimXpertPatternTreatmentType_e.swDimXpertPatternTreatmentType_CircularPattern Then
kadov_tag{{<spaces>}}                kadov_tag{{</spaces>}}strs.Add("Pattern Treatment: Circular pattern")
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}ElseIf patternTreatment = swDimXpertPatternTreatmentType_e.swDimXpertPatternTreatmentType_IndividualFeatures Then
kadov_tag{{<spaces>}}                kadov_tag{{</spaces>}}strs.Add("Pattern Treatment: Individual features")
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}End If
ElseIf annoType = swDimXpertAnnotationType_e.swDimXpertDimTol_Diameter Then
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}Dim diaDim As IDimXpertDiameterDimTol
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}diaDim = annotation
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}patternTreatment = diaDim.PatternTreatment
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}'If patternTreatment Is Nothing Then
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}'strs.Add ("Pattern Treatment: NULL")
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}If patternTreatment = swDimXpertPatternTreatmentType_e.swDimXpertPatternTreatmentType_unknown Then
kadov_tag{{<spaces>}}                kadov_tag{{</spaces>}}strs.Add("Pattern Treatment: unknown")
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}ElseIf patternTreatment = swDimXpertPatternTreatmentType_e.swDimXpertPatternTreatmentType_CircularPattern Then
...
```vb
Dim indReq As Boolean
 Dim envReq  As Boolean
 indReq = diaDim.IndependencyRequirement
 envReq = diaDim.EnvelopeRequirement
 strs.Add("Independency is required: " & indReq)
 strs.Add("Envelope is required: " & envReq)
```
