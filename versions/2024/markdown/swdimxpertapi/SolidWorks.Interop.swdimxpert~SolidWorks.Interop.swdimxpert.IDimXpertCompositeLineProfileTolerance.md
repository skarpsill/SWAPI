---
title: "IDimXpertCompositeLineProfileTolerance Interface"
project: "SOLIDWORKS DimXpert API Help"
interface: "IDimXpertCompositeLineProfileTolerance"
member: ""
kind: "interface"
source: "swdimxpertapi/SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertCompositeLineProfileTolerance.html"
---

# IDimXpertCompositeLineProfileTolerance Interface

Allows you to access DimXpert composite line profile tolerances.
...
```vb
Public Interface IDimXpertCompositeLineProfileTolerance
```
...
```cpp
public interface class IDimXpertCompositeLineProfileTolerance
```
...
[DimXpertCompositeLineProfileTolerance](ms-its:swdimxpertapivb6.chm::/swdimxpert~DimXpertCompositeLineProfileTolerance.html)
