---
title: "IDimXpertConcentricityTolerance Interface"
project: "SOLIDWORKS DimXpert API Help"
interface: "IDimXpertConcentricityTolerance"
member: ""
kind: "interface"
source: "swdimxpertapi/SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertConcentricityTolerance.html"
---

# IDimXpertConcentricityTolerance Interface

Allows you to access DimXpert concentricity tolerances.
...
```vb
Public Interface IDimXpertConcentricityTolerance
```
...
```cpp
public interface class IDimXpertConcentricityTolerance
```
...
[DimXpertConcentricityTolerance](ms-its:swdimxpertapivb6.chm::/swdimxpert~DimXpertCompositeSurfaceProfileTolerance.html)
