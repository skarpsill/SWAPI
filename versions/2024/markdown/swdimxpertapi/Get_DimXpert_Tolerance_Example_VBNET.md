---
title: "Get DimXpert Tolerance Example (VB.NET)"
project: ""
interface: ""
member: ""
kind: "example"
source: "swdimxpertapi/Get_DimXpert_Tolerance_Example_VBNET.htm"
---
...
kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}*kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}Counterbore
dimension tolerance

kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}*kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}Depth dimension
tolerance

```vb
 '---------------------------------------------------------------------------
' Preconditions:
' kadov_tag{{<spaces>}} 1. Open public_documents\samples\tutorial\api\face_plate_ads_geo.sldprt.
'  kadov_tag{{<spaces>}}2. Open the DimXpert toolbar from View > Toolbars.
' kadov_tag{{<spaces>}} 3. Click Auto Dimension Scheme on the DimXpert toolbar.
' kadov_tag{{<spaces>}} 4. Ensure that all feature filters are selected.
' kadov_tag{{<spaces>}} 5. Click the green check mark to accept the settings.
'  kadov_tag{{<spaces>}}6. In the DimXpertManager tab of the Management Panel,
'     expand the Hole Pattern8 node in the DimXpertManager tab of the
'     Management Panel.
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}} 7. Observe the following Dimxpert annotations: kadov_tag{{<spaces>}} kadov_tag{{</spaces>}}Counterbore3 and Depth3
'  kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}8. Open an Immediate window.
'  kadov_tag{{<spaces>}}9. Ensure that the latest SolidWorks.Interop.swdimxpert.dll interop assembly
'     is loaded (right-click the project in Project Explorer and
'     click Add Reference > .NET tab).
'  10. Ensure that the Microsoft Scripting Runtime library is loaded
...
'
' kadov_tag{{<spaces>}}NOTE: Because these parts are used elsewhere, do not save changes.
'--------------------------------------------------------------------------
...
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}Dim cbAnno As IDimXpertCounterBoreDimTol
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}cbAnno = annotation
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}If cbAnno.ReferenceFeature Is Nothing Then
kadov_tag{{<spaces>}}                kadov_tag{{</spaces>}}strs.Add("Reference Feature: NULL")
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}Else
kadov_tag{{<spaces>}}                kadov_tag{{</spaces>}}strs.Add("Reference Feature: " + cbAnno.ReferenceFeature.Name)
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}End If
kadov_tag{{<spaces>}}        kadov_tag{{</spaces>}}ElseIf annoType = swDimXpertAnnotationType_e.swDimXpertDimTol_Depth Then
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}Dim depthAnno As IDimXpertDepthDimTol
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}depthAnno = annotation
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}If depthAnno.ReferenceFeature Is Nothing Then
kadov_tag{{<spaces>}}                kadov_tag{{</spaces>}}strs.Add("Reference Feature: NULL")
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}Else
kadov_tag{{<spaces>}}                kadov_tag{{</spaces>}}strs.Add("Reference Feature: " + depthAnno.ReferenceFeature.Name)
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}End If
