---
title: "OnActiveXControlCreated Method (IPropertyManagerPage2Handler5)"
...
[IPropertyManagerPage2Handler6::OnActiveXControlCreated](SOLIDWORKS.Interop.swpublished~SOLIDWORKS.Interop.swpublished.IPropertyManagerPage2Handler6~OnActiveXControlCreated.html)
...
[PropertyManagerPage2Handler5::OnActiveXControlCreated](ms-its:swpublishedapivb6.chm::/swpublished~PropertyManagerPage2Handler5~OnActiveXControlCreated.html)
...
You cannot get a reference to the ActiveX control inside this event handler because the page is notkadov_tag{{<spaces>}}kadov_tag{{</spaces>}}displayed when this notification is sent. You can only get the reference to the control after the PropertyManager page is displayed.
