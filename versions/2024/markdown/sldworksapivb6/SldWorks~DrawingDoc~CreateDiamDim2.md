---
title: "CreateDiamDim2 Method (DrawingDoc)"
project: "SOLIDWORKS Type Library"
interface: "DrawingDoc"
member: "CreateDiamDim2"
kind: "method"
source: "sldworksapivb6/SldWorks~DrawingDoc~CreateDiamDim2.html"
---

# CreateDiamDim2 Method (DrawingDoc)
...
```vb
Public Function CreateDiamDim2( _
   ByVal DimVal As Double, _
   ByVal VP0 As Variant, _
