---
title: "api/{vaultName}/files/{fileId}/{version}/ActiveConfig?folderId={folderId} (Get)"
project: ""
interface: "r-api-{vaultName}-files-{fileId}-{version}-ActiveConfig-folderId={folderId}"
member: "o-HttpGet"
kind: "topic"
source: "pdmprowebapihelp/PDM Pro API_ws~r-api-{vaultName}-files-{fileId}-{version}-ActiveConfig-folderId={folderId}~o-HttpGet.html"
---

# api/{vaultName}/files/{fileId}/{version}/ActiveConfig?folderId={folderId} (Get)

PDM Pro API Web Service

| Get | api/{vaultName}/files/{fileId}/{version}/ActiveConfig?folderId={folderId} |
| --- | --- |
...
| PDM Pro API Web Service > File Resource Group : api/{vaultName}/files/{fileId}/{version}/ActiveConfig?folderId={folderId} (Get) |
| --- |
