---
title: "api/{vaultName}/files/{fileId}/{folderId}/datacard (Post)"
project: ""
interface: "r-api-{vaultName}-files-{fileId}-{folderId}-datacard"
member: "o-HttpPost"
kind: "topic"
source: "pdmprowebapihelp/PDM Pro API_ws~r-api-{vaultName}-files-{fileId}-{folderId}-datacard~o-HttpPost.html"
---

# api/{vaultName}/files/{fileId}/{folderId}/datacard (Post)

PDM Pro API Web Service

| Post | api/{vaultName}/files/{fileId}/{folderId}/datacard |
| --- | --- |
...
| PDM Pro API Web Service > Data Card Resource Group : api/{vaultName}/files/{fileId}/{folderId}/datacard (Post) |
| --- |
