---
title: "api/{vaultName}/files/{fileId}/{folderId}/versions (Get)"
project: ""
interface: "r-api-{vaultName}-files-{fileId}-{folderId}-versions"
member: "o-HttpGet"
kind: "topic"
source: "pdmprowebapihelp/PDM Pro API_ws~r-api-{vaultName}-files-{fileId}-{folderId}-versions~o-HttpGet.html"
---

# api/{vaultName}/files/{fileId}/{folderId}/versions (Get)

PDM Pro API Web Service

| Get | api/{vaultName}/files/{fileId}/{folderId}/versions |
| --- | --- |
...
| PDM Pro API Web Service > File Resource Group : api/{vaultName}/files/{fileId}/{folderId}/versions (Get) |
| --- |
...
[
  {
    ...
    "FileSize": 4,
    "VersionDate": "2023-12-07T14:34:00.4116891-05:00"
  },
  {
    "InfoType": 0,
    "VersionNumber": 1,
...
<ArrayOfFileRevisionInfo xmlns:i="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://schemas.datacontract.org/2004/07/SWPDM.Models">
  <FileRevisionInfo>
    ...
    <VersionDate>2023-12-07T14:34:00.4116891-05:00</VersionDate>
