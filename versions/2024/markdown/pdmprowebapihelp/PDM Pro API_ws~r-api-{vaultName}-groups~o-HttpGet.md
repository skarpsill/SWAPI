---
title: "api/{vaultName}/groups (Get)"
project: ""
interface: "r-api-{vaultName}-groups"
member: "o-HttpGet"
kind: "topic"
source: "pdmprowebapihelp/PDM Pro API_ws~r-api-{vaultName}-groups~o-HttpGet.html"
---

# api/{vaultName}/groups (Get)
...
| PDM Pro API Web Service > Group Resource Group : api/{vaultName}/groups (Get) |
| --- |
