---
title: "api/{vaultName}/files/{fileId}/{version}/{folderId}/transitions (Get)"
project: ""
interface: "r-api-{vaultName}-files-{fileId}-{version}-{folderId}-transitions"
member: "o-HttpGet"
kind: "topic"
source: "pdmprowebapihelp/PDM Pro API_ws~r-api-{vaultName}-files-{fileId}-{version}-{folderId}-transitions~o-HttpGet.html"
---

# api/{vaultName}/files/{fileId}/{version}/{folderId}/transitions (Get)

PDM Pro API Web Service

| Get | api/{vaultName}/files/{fileId}/{version}/{folderId}/transitions |
| --- | --- |
...
| PDM Pro API Web Service > File Resource Group : api/{vaultName}/files/{fileId}/{version}/{folderId}/transitions (Get) |
| --- |
...
[
  {
    ...
    "Date": "2023-12-07T14:34:00.7768363-05:00",
    "SourceState": {
      "StateId": 1,
...
<ArrayOfHistoryTransition xmlns:i="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://schemas.datacontract.org/2004/07/SWPDM.Models">
  <HistoryTransition>
    ...
    <Date>2023-12-07T14:34:00.7768363-05:00</Date>
    <DestinationState>
