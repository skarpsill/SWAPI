...
member: ""
kind: "example"
source: "API_GB/Graph_Workflow_Example_CSharp.htm"
---
 ...
 namespace PaintWorkflowGraph_CSharp
 {
     public partial class Form1 : Form
     {
         ...
         private void PaintArrow(System.Drawing.Graphics gfx, EdmPoint[] vertices)
         {
             try
             {
                 System.Drawing.PointF[] points = new System.Drawing.PointF[Information.UBound(vertices) + 1];
                 int i = 0;
                 i = Information.LBound(vertices);
                 while (i <= Information.UBound(vertices))
                 {
