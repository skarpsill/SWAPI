...
member: ""
kind: "example"
source: "API_GB/Batch_Update_Variables_Example_CSharp.htm"
---
...
```vb
 ...
 //    EPDM.Interop.epdm.dll, and click  Add).
  // 3. Add Microsoft.VisualBasic and Microsoft.CSharp as references (click
 //    Assemblies > Framework in the left-side panel, select
 //    Microsoft.VisualBasic and Microsoft.CSharp, and click OK).
     ...
     public partial class Form1 : Form
     {
         ...
         private void BatchUpdateButton_Click(System.Object sender, System.EventArgs e)
         {
             try
             {
                 ...
                 int Lo = 0;
                 Lo = Information.LBound(Errors);

                 int Hi = 0;
                 Hi = Information.UBound(Errors);
```
...
```
               IEdmVault9 vault9;
                ...
                while (Lo < Hi - 1)
                {
                    ...
                    Msg = Msg + Constants.vbLf + ErrName + " " + FileName;
