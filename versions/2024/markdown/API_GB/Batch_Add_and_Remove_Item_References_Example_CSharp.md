...
member: ""
kind: "example"
source: "API_GB/Batch_Add_and_Remove_Item_References_Example_CSharp.htm"
---
...
```vb
 ...
 //    structures.
 // 5. Open Start > All Programs > SOLIDWORKS PDM Professional >
 //    Item Explorer.
 ...
 namespace BatchAddItemRefs_CSharp
 {
     public partial class Form1 : Form
     {
         ...
         private void AddItemReference(IEdmVault11 vault)
         {
             ...
             Interaction.MsgBox("Result of operation: " + Constants.vbLf + vault.GetErrorMessage(addRefs[0].mhResult));
