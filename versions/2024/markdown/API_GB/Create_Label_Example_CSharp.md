...
member: ""
kind: "example"
source: "API_GB/Create_Label_Example_CSharp.htm"
---
     ...
     public partial class Form1 : Form
     {
         ...
         public void CreateLabel_Click(System.Object sender, System.EventArgs e)
         {
             ...
             try
             {
                 ...
                 string message = null;
                 message = "The following labels have been set on folder " + parentFolder.Name + ":" + Constants.vbLf;
                 pos = parentFolder.GetFirstLabelPosition();
                 while (!pos.IsNull)
                 {
                     label = (IEdmLabel5)parentFolder.GetNextLabel(pos);
                     message = message + label.Name + " (" + label.Comment + ")" + " created by " + label.User.Name + "(ID = " + label.UserID + ")" + " at " + label.Time + Constants.vbLf;
                 }
