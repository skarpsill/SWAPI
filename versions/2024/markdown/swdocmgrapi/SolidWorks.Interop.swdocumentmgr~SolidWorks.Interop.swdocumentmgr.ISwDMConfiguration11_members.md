---
title: "ISwDMConfiguration11 Interface Members"
project: "SOLIDWORKS Document Manager API Help"
interface: "ISwDMConfiguration11_members"
member: ""
kind: "members"
source: "swdocmgrapi/SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration11_members.html"
---

# ISwDMConfiguration11 Interface Members

The following tables list the members exposed by[ISwDMConfiguration11](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration11.html).

## Public Properties

|  | Name | Description |
| --- | --- | --- |
| Property | BOMPartNoSource | Gets or sets the source of the part number used in the bill of materials (BOM) for this configuration. |
| Property | ShowChildComponentsInBOM | Obsolete. Superseded by ISwDMConfiguration15::ShowChildComponentsInBOM2 . |
...
|  | Name | Description |
| --- | --- | --- |
| Method | GetReplacedComponents | Gets information about the components that were replaced by ISwDMComponent6::Replace . |
| Method | IsSpeedPak | Gets whether this configuration is a SpeedPak. |
