---
title: "ISwDMDocument13 Interface Methods"
project: "SOLIDWORKS Document Manager API Help"
interface: "ISwDMDocument13_methods"
member: ""
kind: "methods"
source: "swdocmgrapi/SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument13_methods.html"
---

# ISwDMDocument13 Interface Methods

For a list of all members of this type, see[ISwDMDocument13 members](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument13_members.html).

## Public Methods

|  | Name | Description |
| --- | --- | --- |
| Method | GetAllExternalReferences4 | Obsolete. Superseded by ISwDMDocument13::GetAllExternalReferences5 . |
| Method | GetCutListItems2 | Obsolete. Superseded by ISwDMConfiguration16::GetCutListItems . |
| Method | GetExternalDesignTable | Gets the path to an external (i.e., linked) design table, if one exists. |
| Method | GetLastUpdateTimeStamp | Gets the last update stamp for this document. |
| Method | GetSheetFormatPath | Gets the path and filename of the sheet format used for the specified sheet. |
| Method | GetSheetProperties | Gets the specified sheet's properties. |
