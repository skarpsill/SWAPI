---
title: "GetBottomFeature Method (ISwDMDimXpertCompoundNotchFeature)"
project: "SOLIDWORKS Document Manager API Help"
interface: "ISwDMDimXpertCompoundNotchFeature"
member: "GetBottomFeature"
kind: "method"
source: "swdocmgrapi/SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDimXpertCompoundNotchFeature~GetBottomFeature.html"
---

# GetBottomFeature Method (ISwDMDimXpertCompoundNotchFeature)

Gets the DimXpert feature at the bottom of this DimXpert compound notch.
...
```vb
Function GetBottomFeature() As SwDMDimXpertFeature
```
...
```csharp
SwDMDimXpertFeature GetBottomFeature()
```
...
[SwDMDimXpertCompoundNotchFeature::GetBottomFeature](ms-its:swdocmgrapivb6.chm::/swdocumentmgr~SwDMDimXpertCompoundNotchFeature~GetBottomFeature.html)
