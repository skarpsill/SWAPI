---
title: "ISwDMDocument19 Interface Members"
project: "SOLIDWORKS Document Manager API Help"
interface: "ISwDMDocument19_members"
member: ""
kind: "members"
source: "swdocmgrapi/SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument19_members.html"
---

# ISwDMDocument19 Interface Members

The following tables list the members exposed by[ISwDMDocument19](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument19.html).

## Public Properties

|  | Name | Description |
| --- | --- | --- |
| Property | CreationDate2 | Gets the date in numeric format that this document was created. |
| Property | LastSavedDate2 | Gets the date in numeric format that this document was last saved. |
...
|  | Name | Description |
| --- | --- | --- |
| Method | Get3rdPartyStorage | Gets an IStream interface to the specified third-party storage of this model document. |
| Method | Get3rdPartyStorageStore | Gets the IStorage interface to the specified third-party storage store of this model document. |
| Method | GetSwDmSettingInteger | Gets the specified document setting. |
| Method | GetSwDmSettingToggle | Gets the specified document setting. |
| Method | Release3rdPartyStorage | Closes the specified third-party storage. |
| Method | Release3rdPartyStorageStore | Closes the specified third-party storage store. |
