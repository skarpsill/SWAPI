---
title: "ISwDMComponent Interface Members"
project: "SOLIDWORKS Document Manager API Help"
interface: "ISwDMComponent_members"
member: ""
kind: "members"
source: "swdocmgrapi/SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMComponent_members.html"
---

# ISwDMComponent Interface Members

The following tables list the members exposed by[ISwDMComponent](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMComponent.html).

## Public Properties

|  | Name | Description |
| --- | --- | --- |
| Property | ConfigurationName | Gets the name of the configuration for this component. |
| Property | Name | Obsolete. Superseded by ISwDMComponent11::Name3 . |
| Property | Transform | Gets the transform for this component. |
...
|  | Name | Description |
| --- | --- | --- |
| Method | IsHidden | Gets whether or not the component is hidden. |
| Method | IsSuppressed | Gets whether or not the component is suppressed. |
