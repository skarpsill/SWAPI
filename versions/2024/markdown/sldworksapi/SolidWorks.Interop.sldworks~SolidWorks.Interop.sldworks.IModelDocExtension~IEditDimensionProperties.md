---
title: "IEditDimensionProperties Method (IModelDocExtension)"
project: "SOLIDWORKS API Help"
interface: "IModelDocExtension"
member: "IEditDimensionProperties"
kind: "method"
source: "sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDocExtension~IEditDimensionProperties.html"
---

# IEditDimensionProperties Method (IModelDocExtension)
...
- `PrefixText`: Text for the prefix of the dimension
...
- `ConfigNames`: - in-process, unmanaged C++: Pointer to an array of configuration names to which to apply these edits (see
