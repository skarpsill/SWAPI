---
title: "IGetPropertyManagerHandleProcedureNames Method (IMacroFeatureData)"
project: "SOLIDWORKS API Help"
interface: "IMacroFeatureData"
member: "IGetPropertyManagerHandleProcedureNames"
kind: "method"
source: "sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IMacroFeatureData~IGetPropertyManagerHandleProcedureNames.html"
---

# IGetPropertyManagerHandleProcedureNames Method (IMacroFeatureData)
...
- `ProcedureCount`: Number of procedures in ModuleName
- `ProcedureNames`: - in-process, unmanaged C++: Pointer to an array of procedure names of size ProcedureCount
