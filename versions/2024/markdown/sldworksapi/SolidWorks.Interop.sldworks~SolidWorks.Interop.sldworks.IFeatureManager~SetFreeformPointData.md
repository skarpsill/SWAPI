---
title: "SetFreeformPointData Method (IFeatureManager)"
...
- `CurveParameter`: Curve where to add the point
- `ParameterOnCurve`: Where on the curve to add the point
- `XOffset`: Value by which to offset x (this value is typically 0, which indicates that the point

was not modified)
- `YOffset`: Value by which to offset y (this value is typically 0, which indicates that the point

was not modified)
- `ZOffset`: Value by which to offset z (this value is typically 0, which indicates that the point
...
[FeatureManager::SetFreeformPointData](ms-its:sldworksapivb6.chm::/sldworks~FeatureManager~SetFreeformPointData.html)
