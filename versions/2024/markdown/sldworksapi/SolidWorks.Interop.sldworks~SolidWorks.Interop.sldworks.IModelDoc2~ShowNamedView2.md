---
title: "ShowNamedView2 Method (IModelDoc2)"
...
- `ViewId`: ID of the view to display as defined by[swStandardViews_e](ms-its:swconst.chm::/SOLIDWORKS.Interop.swconst~SOLIDWORKS.Interop.swconst.swStandardViews_e.html)or -1 to use the VName argument instead; if you specify both VName and ViewId, then ViewId takes precedence if the two arguments do not resolve to the same view

## VBA Syntax

See

[ModelDoc2::ShowNamedView2](ms-its:sldworksapivb6.chm::/sldworks~ModelDoc2~ShowNamedView2.html)
