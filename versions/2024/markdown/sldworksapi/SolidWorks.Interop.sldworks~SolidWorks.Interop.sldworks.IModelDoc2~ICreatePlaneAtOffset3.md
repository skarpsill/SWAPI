---
title: "ICreatePlaneAtOffset3 Method (IModelDoc2)"
project: "SOLIDWORKS API Help"
interface: "IModelDoc2"
member: "ICreatePlaneAtOffset3"
kind: "method"
source: "sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~ICreatePlaneAtOffset3.html"
---

# ICreatePlaneAtOffset3 Method (IModelDoc2)
...
- `Val`: Offset distance from selected plane in meters
- `FlipDir`: True to flip the plane the other way for first direction, false to not
- `AutoSize`: True to automatically size the the plane, false to not
...
[ModelDoc2::ICreatePlaneAtOffset3](ms-its:sldworksapivb6.chm::/sldworks~ModelDoc2~ICreatePlaneAtOffset3.html)
