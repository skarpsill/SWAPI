---
title: "IGetTrackingIDs Method (IFace2)"
project: "SOLIDWORKS API Help"
interface: "IFace2"
member: "IGetTrackingIDs"
kind: "method"
source: "sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFace2~IGetTrackingIDs.html"
---
...
- `Count`: Number of tracking IDs on this face
- `TrackingIDs`: - in-process, unmanaged C++: Pointer to an array of tracking IDs on this face
...
Before calling this method, call[IFace2::GetTrackingIDsCount](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IFace2~GetTrackingIDsCount.html)to get Count.
