---
title: "Evaluate Method (ISurface)"
project: "SOLIDWORKS API Help"
interface: "ISurface"
member: "Evaluate"
kind: "method"
source: "sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISurface~Evaluate.html"
---
...
where thenth derivative wrt u (i <=`N umUDerivs`)

and thenth derivative wrt v (j <=NumVDerivs)
...
[Surface::Evaluate](ms-its:sldworksapivb6.chm::/sldworks~Surface~Evaluate.html)
