---
title: "CreateBsplineSurface Method (IBody2)"
project: "SOLIDWORKS API Help"
interface: "IBody2"
member: "CreateBsplineSurface"
kind: "method"
source: "sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IBody2~CreateBsplineSurface.html"
---
...
- `Props`: Array containing 8 integers packed as 4 double elements (see**Remarks**)
- `UKnots`: Array of numUKnots (seeRemarks)
- `VKnots`: Array of numVKnots (seeRemarks)
...
[Body2::CreateBsplineSurface](ms-its:sldworksapivb6.chm::/sldworks~Body2~CreateBsplineSurface.html)
