---
title: "ICreateSplinesByEqnParams Method (IModelDoc2)"
project: "SOLIDWORKS API Help"
interface: "IModelDoc2"
member: "ICreateSplinesByEqnParams"
kind: "method"
source: "sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~ICreateSplinesByEqnParams.html"
---
...
[ISketchManager::ICreateSplinesByEqnParams](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.ISketchManager~ICreateSplinesByEqnParams.html)
...
- `PropArray`: Array of dimension, order, number of control points, periodicity (see

Remarks

)
- `KnotsArray`: knot1, knot2, and so on (see

Remarks

)
- `CntrlPntCoordArray`: controlpoint1[dimension], controlpoint2[dimension], and so on (see
...
[splines enumeration](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IEnumSketchSegments.html)
...
[ModelDoc2::ICreateSplinesByEqnParams](ms-its:sldworksapivb6.chm::/sldworks~ModelDoc2~ICreateSplinesByEqnParams.html)
...
You can use the returned object pointer directly to call any APIs on the[ISketchSegment](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.ISketchSegment.html)interface, or use QueryInterface to obtain the pointer to the ISketchSpline and any APIs on the[ISketchSpline](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.ISketchSpline.html)interface.
