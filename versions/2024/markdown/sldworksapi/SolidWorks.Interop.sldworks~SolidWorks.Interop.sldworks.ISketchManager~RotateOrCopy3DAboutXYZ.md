---
title: "RotateOrCopy3DAboutXYZ Method (ISketchManager)"
project: "SOLIDWORKS API Help"
interface: "ISketchManager"
member: "RotateOrCopy3DAboutXYZ"
kind: "method"
source: "sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchManager~RotateOrCopy3DAboutXYZ.html"
---
...
- `Copy`: True to copy 3D sketch entities, false to not
- `NumCopies`: Number of copies
- `KeepRelations`: True to keep sketch relations, false to not
- `BaseX`: X coordinate from the base point from which to rotate the 3D sketch entities
- `BaseY`: Y coordinate from the base point from which to rotate the 3D sketch entities
- `BaseZ`: Z coordinate from the base point from which to rotate the 3D sketch entities
- `AngleAboutXDir`: Angle to rotate the 3D sketch entities in the x direction
- `AngleAboutYDir`: Angle to rotate 3D sketch entities in the y direction
- `AngleAboutZDir`: Angle to rotate 3D sketch entities in the z direction
...
[SketchManager::RotateOrCopy3DAboutXYZ](ms-its:sldworksapivb6.chm::/sldworks~SketchManager~RotateOrCopy3DAboutXYZ.html)
...
[ISketchManager::RotateOrCopy3DAboutVector Method](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ISketchManager~RotateOrCopy3DAboutVector.html)
