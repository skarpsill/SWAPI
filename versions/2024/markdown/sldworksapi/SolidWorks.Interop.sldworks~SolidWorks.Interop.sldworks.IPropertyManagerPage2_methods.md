---
title: "IPropertyManagerPage2 Interface Methods"
project: "SOLIDWORKS API Help"
interface: "IPropertyManagerPage2_methods"
member: ""
kind: "methods"
source: "sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IPropertyManagerPage2_methods.html"
---

# IPropertyManagerPage2 Interface Methods

For a list of all members of this type, see[IPropertyManagerPage2 members](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IPropertyManagerPage2_members.html).

## Public Methods

|  | Name | Description |
| --- | --- | --- |
| Method | AddControl | Obsolete. Superseded by IPropertyManagerPage2::AddControl2 . |
| Method | AddControl2 | Adds a control to this PropertyManager page. |
| Method | AddGroupBox | Adds a group box to a PropertyManager page. |
| Method | AddMenuPopupItem | Adds a menu item to the pop-up menu for this PropertyManager page. |
| Method | AddTab | Adds a tab to a PropertyManager page. |
| Method | Close | Closes the current page in the PropertyManager. |
| Method | EnableButton | Sets whether to enable the buttons on the PropertyManager. |
| Method | GetFocus | Gets the ID of the control that has focus on this PropertyManager page. |
| Method | IAddControl | Obsolete. Superseded by IPropertyManagerPage2::AddControl2 . |
| Method | IAddGroupBox | Adds a group box to a PropertyManager page. |
| Method | SetCursor | Sets the cursor after a selection is made in the SOLIDWORKS graphics area. |
| Method | SetExitConfirmationCursor | Obsolete. Superseded by IPropertyManagerPage2::SetCursor . |
| Method | SetFocus | Sets focus on the specified control on this PropertyManager page. |
| Method | SetMessage | Obsolete. Superseded by IPropertyManagerPage2::SetMessage2 . |
| Method | SetMessage2 | Obsolete. Superseded by PropertyManagerPage2::SetMessage3 . |
| Method | SetMessage3 | Sets the message in this PropertyManager page. |
| Method | SetTitleBitmap | Obsolete. Superseded by IPropertyManagerPage2::SetTitleBitmap2 . |
| Method | SetTitleBitmap2 | Sets the bitmap to display in the title of this PropertyManager page. |
| Method | SetTitleBitmapx64 | Sets the bitmap to display in the title of this PropertyManager page. |
| Method | Show | Obsolete. Superseded by IPropertyManagerPage2::Show2 . |
| Method | Show2 | Shows the PropertyManager page. |
