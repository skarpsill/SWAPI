---
title: "Execute Template and Return Data Example (C#)"
project: ""
interface: ""
member: ""
kind: "example"
source: "API_GB/Execute_Template_2_Example_CSharp.htm"
---
...
//     structures.
//  5. Ensure that a template exists in the vault that you plan to
     ...
     public partial class Form1 : Form
     {
         ...
         private void ExecuteTemplateButton_Click(System.Object sender, System.EventArgs e)
         {
             ...
             try
             {
                 ...
                 string message = "";
                 message = "Installed template in vault, " + vault2.Name + ", to use:" + Constants.vbLf + Constants.vbLf;
                 ...
                 while (!pos.IsNull)
                 {
                     ...
                     message = message + template.GetMenuString() + Constants.vbLf;
                     ...
                     object[] retData = null;
                     refreshFlag = (EdmRefreshFlag)template.RunEx(this.Handle.ToInt32(), vault1.RootFolderID, out retData);
                     ...
                     else
                     {
                         ...
                         long idx = 0;
                         idx = Information.LBound(retData);
                         long upper = 0;
                         upper = Information.UBound(retData);

                         EdmData data = default(EdmData);
                         message = "Template generated:" + Constants.vbLf;
                         string row = null;
                         ...
                         while (idx <= upper)
                         {
                             ...
                             idx = idx + 1;
                             message = message + row + Constants.vbLf;
                         }
