---
title: "Visual C++/CLI Standalone and Add-in Applications"
project: ""
interface: ""
member: ""
kind: "topic"
...
//Use[ATL smart pointers](../Overview/Smart_Pointers.htm)kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}
...
.kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}//Your
code

.

//Shut down SOLIDWORKSkadov_tag{{<spaces>}}kadov_tag{{</spaces>}}
...
You can create a Visual C++/CLI DLL add-in using theSOLIDWORKS
COM Add-In Wizardincluded in the[SOLIDWORKS
...
<param name="Items" value="StandaloneApplicationsLibraries$$**$$VisualC++6StandaloneApplicationsLibraryFiles$$**$$">
<param name="Image" value>
<param name="FontInfo" value="MS Sans Serif,8,0,,">
<param name="_CURRENTFILEPATH" value="K:\HELP\Cheryle_Working_Folder\SW2010\ROBOHELP\sldworksAPIProgGuide\GettingStarted\CPP_.NET_Standalone_and_Add-in_Applications.htm">
