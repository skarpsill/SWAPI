---
title: "InsertNetBlend2 Method (FeatureManager)"
project: "SOLIDWORKS Type Library"
interface: "FeatureManager"
member: "InsertNetBlend2"
kind: "method"
source: "sldworksapivb6/SldWorks~FeatureManager~InsertNetBlend2.html"
---

# InsertNetBlend2 Method (FeatureManager)
...
```vb
Public Function InsertNetBlend2( _
   ByVal Type As Integer, _
   ByVal NCurvesDir1 As Integer, _
   ByVal NCurvesDir2 As Integer, _
   ...
   ByVal ThinSolidType As Integer, _
   ...
   ByVal CreateSolid As Boolean _
) As Feature
```
