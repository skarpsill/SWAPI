---
title: "InsertProtrusionBlend2 Method (FeatureManager)"
project: "SOLIDWORKS Type Library"
interface: "FeatureManager"
member: "InsertProtrusionBlend2"
kind: "method"
source: "sldworksapivb6/SldWorks~FeatureManager~InsertProtrusionBlend2.html"
---

# InsertProtrusionBlend2 Method (FeatureManager)
...
```vb
Public Function InsertProtrusionBlend2( _
   ...
   ByVal GuideCurveInfluence As Long _
) As Feature
```
