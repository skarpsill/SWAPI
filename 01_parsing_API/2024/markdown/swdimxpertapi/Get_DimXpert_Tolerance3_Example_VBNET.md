---
title: "Get DimXpert Tolerance3 Example (VB.NET)"
project: ""
interface: ""
member: ""
kind: "example"
source: "swdimxpertapi/Get_DimXpert_Tolerance3_Example_VBNET.htm"
---
...
```vb
 '----------------------------------------------------------------------------
' Preconditions:
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}1. Open public_documents\samples\tutorial\api\cover_position.sldprt.
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}2. Create a composite position tolerance:
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}   a. Click Geometric Tolerance on the DimXpert toolbar.
' kadov_tag{{<spaces>}}   b. In the Geometric Tolerance Properties dialog:
' kadov_tag{{<spaces>}}      kadov_tag{{</spaces>}}a. Select Position from in Symbol
' kadov_tag{{<spaces>}}      b. Type A in Primary, B in Secondary, and C in Tertiary.
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}   c. In second row (lower tier), select Position in Symbol.
' kadov_tag{{<spaces>}}      kadov_tag{{</spaces>}}d. Type 0.25 in Tolerance 1.
' kadov_tag{{<spaces>}}      kadov_tag{{</spaces>}}e. Type A in Primary.
' kadov_tag{{<spaces>}}      kadov_tag{{</spaces>}}f. Select the Composite frame check box.
' kadov_tag{{<spaces>}}      g. Click the circular face of the boss.
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}   h. Click away from the part to place the annotation.
' kadov_tag{{<spaces>}}      i. Click OK to close the Geometric Tolerance Properties dialog.
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}3. In the DimXpertManager tab of the Management Panel, expand Plane2.
' kadov_tag{{<spaces>}}4. Observe the following DimXpert annotations in the DimXpert tree:
'   kadov_tag{{<spaces>}} kadov_tag{{</spaces>}}Perpendicularity1, Position1, and CompositePosition1.
' kadov_tag{{<spaces>}}5. Ensure that the SolidWorks.Interop.swdimxpert.dll interop
'    assembly is loaded (right-click on the project in Project Explorer and
'    click Add Reference > .NET tab).
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}6. Ensure that the Microsoft Scripting Runtime library is loaded
' kadov_tag{{<spaces>}}   (right-click on the project in Project Explorer and click Add Reference >
'    COM tab).
'
' Postconditions:
