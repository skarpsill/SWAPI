---
title: "IDimXpertCompositeSurfaceProfileTolerance Interface"
project: "SOLIDWORKS DimXpert API Help"
interface: "IDimXpertCompositeSurfaceProfileTolerance"
member: ""
kind: "interface"
source: "swdimxpertapi/SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertCompositeSurfaceProfileTolerance.html"
---

# IDimXpertCompositeSurfaceProfileTolerance Interface

Allows you to access DimXpert composite surface profile tolerances.
...
```vb
Public Interface IDimXpertCompositeSurfaceProfileTolerance
```
...
```cpp
public interface class IDimXpertCompositeSurfaceProfileTolerance
```
...
[DimXpertCompositeSurfaceProfileTolerance](ms-its:swdimxpertapivb6.chm::/swdimxpert~DimXpertCompositeSurfaceProfileTolerance.html)
