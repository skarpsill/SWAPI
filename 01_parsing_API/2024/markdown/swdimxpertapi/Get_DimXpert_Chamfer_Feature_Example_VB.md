---
title: "Get DimXpert Chamfer Feature Example (VBA)"
project: ""
interface: ""
member: ""
kind: "example"
...
Openpublic_documents\samples\tutorial\api\plate_tolstatus.sldprt.
...
Ensure that the chamfer feature filter is selected.kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}

'kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}5.
Click the green check mark to accept all settings.

'kadov_tag{{<spaces>}}6. Observe this DimXpert featurs on the DimXpertManager tab
...
Dim chamferType As swDimXpertChamferType_e

Dim chamferAngleType As swDimXpertChamferAngleType_e
...
kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}If
(angleType = swDimXpertChamferAngleType_Concave)
Then
