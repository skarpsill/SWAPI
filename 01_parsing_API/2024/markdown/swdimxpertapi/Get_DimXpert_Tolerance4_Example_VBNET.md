---
title: "Get DimXpert Tolerance4 Example (VB.NET)"
project: ""
interface: ""
member: ""
kind: "example"
source: "swdimxpertapi/Get_DimXpert_Tolerance4_Example_VBNET.htm"
---

# Get DimXpert Tolerance4 Example (VB.NET)
...
' kadov_tag{{<spaces>}}Create the chamfer dimension tolerance:
...
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}1. Click Location Dimension on the DimXpert toolbar.
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}2. Click a face of the part.
...
' kadov_tag{{<spaces>}}5. Find the following Dimxpert annotation in the DimXpert tree: kadov_tag{{<spaces>}} kadov_tag{{</spaces>}}AngleBetween1.

' Create line profile and straightness tolerances:
' kadov_tag{{<spaces>}}1. Click Geometric Tolerance on the DimXpert tool bar.
' kadov_tag{{<spaces>}}2. In the Geometric Tolerance Properties dialog:
' kadov_tag{{<spaces>}}   a. Select Straightness in Symbol.
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}b. In second row, select Profile of Line in Symbol.
' kadov_tag{{<spaces>}}   c. Type 0.25 in Tolerance 1.
' kadov_tag{{<spaces>}}   d. Click the top face of the part.
' kadov_tag{{<spaces>}}   e. Click to place the annotation.
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}f. Click OK close the Geometric Tolerance Properties dialog.
' 3. In the DimXpertManager tab of the Management Panel, expand Plane7.
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}4. Observe the following Dimxpert annotations: kadov_tag{{</spaces>}}LineProfile1 and Straightness1
'
' Before running this macro:
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}1. Ensure that the SolidWorks.Interop.swdimxpert.dll interop assembly
...
' kadov_tag{{<spaces>}}   (right-click the project in Project Explorer and click Add Reference >
'    COM tab).
'
' Postconditions:
...
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}isAngleType = True
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}Dim angleBetweenAnno As IDimXpertAngleBetweenDimTol
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}angleBetweenAnno = annotation
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}' the origin and tolerance feature
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}strs.Add("Origin Feature: " + angleBetweenAnno.OriginFeature.Name)
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}' is supplement angle
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}strs.Add("Supplement Angle: " + IIf(angleBetweenAnno.Supplement, "True", "False"))
