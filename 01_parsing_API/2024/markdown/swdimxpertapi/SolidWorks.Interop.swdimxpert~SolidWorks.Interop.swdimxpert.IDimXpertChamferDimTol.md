---
title: "IDimXpertChamferDimTol Interface"
project: "SOLIDWORKS DimXpert API Help"
interface: "IDimXpertChamferDimTol"
member: ""
kind: "interface"
source: "swdimxpertapi/SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertChamferDimTol.html"
---

# IDimXpertChamferDimTol Interface

Allows you to access DimXpert chamfer dimension tolerances.
...
```vb
Public Interface IDimXpertChamferDimTol
```
...
```cpp
public interface class IDimXpertChamferDimTol
```
...
[DimXpertChamferDimTol](ms-its:swdimxpertapivb6.chm::/swdimxpert~DimXpertChamferDimTol.html)
...
You can access more general dimension tolerance information using
