---
title: "IDimXpertSurfaceProfileTolerance Interface"
project: "SOLIDWORKS DimXpert API Help"
interface: "IDimXpertSurfaceProfileTolerance"
member: ""
kind: "interface"
source: "swdimxpertapi/SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertSurfaceProfileTolerance.html"
---

# IDimXpertSurfaceProfileTolerance Interface

Allows you to access DimXpert surface profile tolerances.
...
```vb
Public Interface IDimXpertSurfaceProfileTolerance
```

### Visual Basic (Usage)

```vb
Dim instance As IDimXpertSurfaceProfileTolerance
```
...
```cpp
public interface class IDimXpertSurfaceProfileTolerance
```
...
[DimXpertSurfaceProfileTolerance](ms-its:swdimxpertapivb6.chm::/swdimxpert~DimXpertSurfaceProfileTolerance.html)
...
[IDimXpertSurfaceProfileTolerance Members](SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertSurfaceProfileTolerance_members.html)
