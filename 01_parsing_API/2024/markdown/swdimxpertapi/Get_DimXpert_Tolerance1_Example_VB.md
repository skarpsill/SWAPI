---
title: "Get DimXpert Tolerance1 Example (VBA)"
project: ""
interface: ""
member: ""
kind: "example"
source: "swdimxpertapi/Get_DimXpert_Tolerance1_Example_VB.htm"
---

# Get DimXpert Tolerance1 Example (VBA)
...
' kadov_tag{{<spaces>}}2. Click Geometric Tolerance on the DimXpert toolbar.
' kadov_tag{{<spaces>}}   In the Geometric Tolerance Properties dialog:
' kadov_tag{{<spaces>}}   a. Select Cylindricity from the Symbol dropdown.
...
' kadov_tag{{<spaces>}}   c. Click the outer base cylinder and click again outside the part
'       to place the annotation.
' kadov_tag{{<spaces>}}   d. Click OK to close the Geometric Tolerance Properties dialog.
' kadov_tag{{<spaces>}}3. In the DimXpertManager tab of the Management Panel,
...
'    Flatness1, Circularity1, Diameter1,
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}CounterSinkAngle1, CounterSinkDiameter1, Cylindricity1,
'    and Surface Profile1
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}5. Ensure that the latest SOLIDWORKS DimXpert type library is loaded
