---
title: "Get DimXpert Datum Example (VBA)"
project: ""
interface: ""
member: ""
kind: "example"
source: "swdimxpertapi/Get_DimXpert_Datum_Example_VB.htm"
---

# Get DimXpert Datum Example (VBA)
...
'---------------------------------------------------------------------------
' Preconditions:
'  kadov_tag{{<spaces>}}1. Open public_documents\samples\tutorial\cosmosfloxpress\ball valve\ball.sldprt.
...
'     of the Management Panel: kadov_tag{{</spaces>}}Sphere1.
' kadov_tag{{<spaces>}} 8. Open an Immediate window.
'  kadov_tag{{<spaces>}}9. Ensure that the SOLIDWORKS DimXpert type library is loaded
'     in Tools > References.
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}10. Ensure that the Microsoft Scripting Runtime library is loaded
'     in Tools > References.
'
' Postconditions:
'  1. Writes the output of this macro to  c:\temp\dimXpertInfo.txt.
