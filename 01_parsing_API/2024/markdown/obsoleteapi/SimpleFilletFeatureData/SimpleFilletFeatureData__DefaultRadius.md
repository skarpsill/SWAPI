---
title: "SimpleFilletFeatureData::DefaultRadius"
project: ""
interface: ""
member: ""
kind: "topic"
...
radius= SimpleFilletFeatureData.GetDefaultRadius ( ) (C++ Get property)
...
status = SimpleFilletFeatureData ->get_DefaultRadius
( &radius)

status = SimpleFilletFeatureData ->put_DefaultRadius
(radius)
...
<param name="_CURRENTFILEPATH" value="C:\Home\Oneill\sw2003\SimpleFilletFeatureData\SimpleFilletFeatureData__DefaultRadius.htm" >
