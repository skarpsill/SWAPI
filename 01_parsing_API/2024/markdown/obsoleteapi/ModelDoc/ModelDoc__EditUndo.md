...
SolidWorks session. This method corresponds to theEdit,
Undocommands in the user interface.
...
| Input: | (ULONG) nSteps | Number of steps to reverse in the active SolidWorks
session |
| --- | --- | --- |
...
<param name="_CURRENTFILEPATH" value="D:\APIHelp\sw2003\ModelDoc\ModelDoc__EditUndo.htm" >
