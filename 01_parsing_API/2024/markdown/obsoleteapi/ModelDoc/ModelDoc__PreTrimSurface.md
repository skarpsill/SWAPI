...
This
method is obsolete and has been superseded by[ModelDoc2::PreTrimSurface](sldworksAPI.chm::/ModelDoc2/ModelDoc2__PreTrimSurface.htm).
...
| Input: | (VARIANT_BOOL) bMutualTrimIn | TRUE to use the mutual trim option, FALSE otherwise |
| --- | --- | --- |
...
<param name="_CURRENTFILEPATH" value="D:\APIHelp\sw2003\ModelDoc\ModelDoc__PreTrimSurface.htm" >
