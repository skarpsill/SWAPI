---
title: "View::GetPolylines6"
project: ""
interface: ""
member: ""
kind: "topic"
source: "obsoleteapi/View/View__GetPolylines6.htm"
---

# View::GetPolylines6

This method is obsolete and has been superseded
by[View::GetPolylines7](sldworksAPI.chm::/View/View__GetPolylines7.htm).
...
Edges = View.GetPolylines6 ( CrossHatchOption, Polylines)
...
| --- | --- | --- |
| Output: | (VARIANT) Polylines | VARIANT of type SafeArray of
lines in the view |
| Output: | (VARIANT) Edges | VARIANT of type SafeArray of modeling edges corresponding
to polyines in the view |

Syntax (COM)

status = View->IGetPolylines6 ( CrossHatchOption,
ArraySize, &Polylines, EdgeArraySize, &Edges)
...
= include only crosshatch lines |
| --- | --- | --- |
| Input: | (long) ArraySize | Size of array of lines |
| Output: | (double) Polylines | Array of lines in the view of size ArraySize |
| Input: | (long) EdgeArraySize | Size of array of modeling edges |
| Output: | (LPEDGE) Edges | Array of modeling edges corresponding to polyline
in the view |
...
NOTE: If
the view contains silhouette edges, then the polylines that render them
cannot correspond to an edge because an edge does not actually exist.
For example, if the third and fourth polyline in the set of polylines
returned describe a silhouette edge, then array positions 4 and 5 in the
edge array will be null.
...
<param name="_CURRENTFILEPATH" value="C:\cheryle\APIHelp\sw2008\obsoleteapi\View\View__GetPolylines6.htm" >
...
<param name="ControlLabel" value="See Also" >
<param name="UseIcon" value="0" >
<param name="Items" value="View_Object$$**$$ViewDisplayMode$$**$$DrawingViewsModelEntities$$**$$" >
<param name="Image" value="" >
<param name="FontInfo" value="MS Sans Serif,8,0,," >
<param name="_CURRENTFILEPATH" value="C:\cheryle\APIHelp\sw2008\obsoleteapi\View\View__GetPolylines6.htm" >
