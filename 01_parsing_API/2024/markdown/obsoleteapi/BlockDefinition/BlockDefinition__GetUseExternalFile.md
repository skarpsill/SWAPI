---
title: "BlockDefinition::GetUseExternalFile"
project: ""
interface: ""
member: ""
kind: "topic"
...
| Output: | (BOOL) UseFile | TRUE if this block definition is linked to an external file, FALSE if
not |
| --- | --- | --- |
...
| Output: | (VARIANT_BOOL) UseFile | TRUE if this block definition is linked to an external file, FALSE if
not |
| --- | --- | --- |
...
<param name="_CURRENTFILEPATH" value="C:\cheryle\APIHelp\sw2007\obsoleteapi\BlockDefinition\BlockDefinition__GetUseExternalFile.htm" >
...
<param name="ControlLabel" value="See Also" >
<param name="UseIcon" value="0" >
<param name="Items" value="EXBlocks$$**$$" >
<param name="Image" value="" >
<param name="FontInfo" value="MS Sans Serif,8,0,," >
<param name="_CURRENTFILEPATH" value="C:\cheryle\APIHelp\sw2007\obsoleteapi\BlockDefinition\BlockDefinition__GetUseExternalFile.htm" >
