---
title: "Component::RemoveMaterialProperty"
project: ""
interface: ""
member: ""
kind: "topic"
...
| Return: | (BOOL) retval | TRUE if the material property was removed, FALSE
if not |
| --- | --- | --- |
...
| Output: | (VARIANT_BOOL) retval | TRUE if the material property was removed, FALSE
if not |
| --- | --- | --- |
| Return: | (HRESULT) retval | S_OK if successful; S_FALSE otherwise |
...
<param name="_CURRENTFILEPATH" value="D:\APIHelp\sw2004\obsoleteapi\Component\Component__RemoveMaterialProperty.htm" >
