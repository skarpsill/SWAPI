...
| Input: | (VARIANT_BOOL) dir | TRUE if you want Direction 1 to be opposite the default direction (see Remarks ) |
...
<param name="_CURRENTFILEPATH" value="C:\cheryle\APIHelp\sw2005\obsoleteapi\ModelDoc2\ModelDoc2__FeatureBoss2.htm" >
