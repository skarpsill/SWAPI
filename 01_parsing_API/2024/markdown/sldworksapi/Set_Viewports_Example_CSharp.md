...
namespace ViewportModelViewManager_CSharp.csproj
{
...
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}ModelViewManager swModelViewManager = default(ModelViewManager);
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}ModelView swModelView = default(ModelView);
...
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}swModelViewManager.ViewportDisplay = (int)swViewportDisplay_e.swViewportTwoViewHorizontal;
...
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}swModelView = (ModelView)swModel.ActiveView;
...
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}swModelViewManager.ViewportDisplay = (int)swViewportDisplay_e.swViewportSingle;
