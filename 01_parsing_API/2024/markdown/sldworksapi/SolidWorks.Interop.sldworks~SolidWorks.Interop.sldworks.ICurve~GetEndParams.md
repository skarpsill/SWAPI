---
title: "GetEndParams Method (ICurve)"
project: "SOLIDWORKS API Help"
interface: "ICurve"
member: "GetEndParams"
kind: "method"
source: "sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.ICurve~GetEndParams.html"
---

# GetEndParams Method (ICurve)
...
- `IsClosed`: True for closed curves, false for other types
- `IsPeriodic`: True for periodic curves, false for other types
...
[Curve::GetEndParams](ms-its:sldworksapivb6.chm::/sldworks~Curve~GetEndParams.html)
