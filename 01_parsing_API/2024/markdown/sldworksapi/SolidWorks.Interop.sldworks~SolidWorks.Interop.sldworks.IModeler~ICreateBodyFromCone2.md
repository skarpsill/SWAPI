---
title: "ICreateBodyFromCone2 Method (IModeler)"
...
- `ConeDimArray`: Array of 9 doubles (see
...
[Modeler::ICreateBodyFromCone2](ms-its:sldworksapivb6.chm::/sldworks~Modeler~ICreateBodyFromCone2.html)
