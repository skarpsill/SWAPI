...
member: ""
kind: "example"
source: "sldworksapi/Insert_and_Use_Plane_with_Manipulator_Example_VBNET.htm"
---
...
```vb
 ...
 ' Preconditions:
 ' 1. In the IDE:
 '    a. Click Project > Add Reference > SolidWorks.Interop.swpublished
 '       on the .NET tab.
 ...
 ' Postconditions:
 ' 1. Opens the part.
 ' 2. Displays a plane with manipulator.
 ...
 '    handler. Gets the handle index at each drag.
