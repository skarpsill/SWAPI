---
title: "UploadToMySolidWorksSettings Method (ISldWorks)"
...
Uploads the specified SOLIDWORKS Desktop settings to
...
- `SystemOptions`: True to upload, false to not
- `FileLocations`: True to upload, false to not
- `Customizations`: True to upload, false to not
...
[SldWorks::UploadToMySolidWorksSettings](ms-its:sldworksapivb6.chm::/sldworks~SldWorks~UploadToMySolidWorksSettings.html)
