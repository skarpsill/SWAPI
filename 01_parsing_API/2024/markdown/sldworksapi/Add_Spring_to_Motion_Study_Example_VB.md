---
title: "Add Spring to Motion Study Example (VBA)"
project: ""
interface: ""
member: ""
kind: "example"
...
'----------------------------------------------------------------------------
 ...
 ' 1. Open kadov_tag{{</spaces>}}public_documents\samples\tutorial\api\wrench.sldasm.
 ...
 ' kadov_tag{{<spaces>}}3. Reference the SOLIDWORKS MotionStudy type library.
...
kadov_tag{{<spaces>}}    kadov_tag{{</spaces>}}swMotionStudy1.Activatekadov_tag{{<spaces>}}    kadov_tag{{</spaces>}}
kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}
