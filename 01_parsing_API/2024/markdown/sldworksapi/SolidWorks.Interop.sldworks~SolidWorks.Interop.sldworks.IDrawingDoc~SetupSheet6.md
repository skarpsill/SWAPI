---
title: "SetupSheet6 Method (IDrawingDoc)"
...
- `Name`: Name of the sheet to set up
...
; valid only if TemplateIn is set to swDwgTemplates_e.swDwgTemplateNone
...
[DrawingDoc::SetupSheet6](ms-its:sldworksapivb6.chm::/sldworks~DrawingDoc~SetupSheet6.html)
