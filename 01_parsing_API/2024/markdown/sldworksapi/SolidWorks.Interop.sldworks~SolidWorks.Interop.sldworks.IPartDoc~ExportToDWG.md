---
title: "ExportToDWG Method (IPartDoc)"
project: "SOLIDWORKS API Help"
interface: "IPartDoc"
member: "ExportToDWG"
kind: "method"
source: "sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IPartDoc~ExportToDWG.html"
---

# ExportToDWG Method (IPartDoc)
...
- `FilePath`: Full path to the directory of the exported DXF/DWG file
- `ModelName`: File and path name of the active part document
...
[IPartDoc::IExportToDWG Method](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IPartDoc~IExportToDWG.html)
