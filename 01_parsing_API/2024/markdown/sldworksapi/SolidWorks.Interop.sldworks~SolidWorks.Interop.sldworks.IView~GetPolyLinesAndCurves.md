---
title: "GetPolyLinesAndCurves Method (IView)"
project: "SOLIDWORKS API Help"
interface: "IView"
member: "GetPolyLinesAndCurves"
kind: "method"
source: "sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IView~GetPolyLinesAndCurves.html"
---

# GetPolyLinesAndCurves Method (IView)
...
Array of lines and parameters in the view (see
...
[View::GetPolyLinesAndCurves](ms-its:sldworksapivb6.chm::/sldworks~View~GetPolyLinesAndCurves.html)

.

## Remarks

The difference between this method and[IView::GetPolylines7](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IView~GetPolylines7.html)is that splines and ellipses returned by this method are returned as equation parameters, which are more precise definitions.
...
- next six doubles are line attributes:
  ...
  - LayerID= integer value indicating which layer holds this polyline. The[ILayer](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.ILayer.html)object can be obtained by passing this integer value to[ILayerMgr::GetLayerById](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.ILayerMgr~GetLayerById.html).
...
| Items that were sketched in this drawing view | IView::GetArcs4 IView::GetLines4 IView::GetSplines3 IView::GetEllipses5 |
