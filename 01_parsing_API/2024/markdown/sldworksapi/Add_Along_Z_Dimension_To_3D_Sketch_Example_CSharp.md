---
title: "Add Along Z Dimension to 3D Sketch Example (C#)"
project: ""
interface: ""
member: ""
kind: "example"
source: "sldworksapi/Add_Along_Z_Dimension_To_3D_Sketch_Example_CSharp.htm"
---
...
// 4. Puts 3DSketch1 in edit mode; 3DSketch1 contains a spline and a corner
//    rectangle.
// 5. Displays the display dimension of 64.81 mm on the z axis starting at
...
namespace Macro1CSharp.csproj
{
    public partial class SolidWorksMacro
    {
        ...
        public void Main()
        {
            ...
            myDisplayDim = (DisplayDimension)Part.SketchManager.AddAlongZDimension(-0.03841894197919, -0.03273212874668, 0.042510877252);
            Part.ClearSelection2(true);
