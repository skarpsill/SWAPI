---
title: "Create a Sketch Point Example (VB.NET)"
project: ""
interface: ""
member: ""
kind: "example"
...
```vb
 ...
 Partial Class SolidWorksMacro
     ...
     Sub main()
         ...
         swModel = swApp.NewDocument("C:\ProgramData\SOLIDWORKS\SOLIDWORKS 2012\templates\Part.prtdot", 0, 0, 0)
         swApp.ActivateDoc2("Part1", False, longstatus)
         swModel = swApp.ActiveDoc

         swSkMgr = swModel.SketchManager
         swSkMgr.InsertSketch(True)
         boolstatus = swModel.Extension.SelectByID2("Top Plane",  "PLANE", -0.0553489443349025, 0.00330468607538553, 0.0269617286188933,  False, 0,  Nothing, 0)
