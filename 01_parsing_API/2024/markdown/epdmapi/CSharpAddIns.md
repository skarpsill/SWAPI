...
member: ""
kind: "topic"
source: "epdmapi/CSharpAddIns.htm"
---

# Creating Add-ins (C#)

This topic shows how to create a
debug add-in using Visual C# in Microsoft Visual Studio.NOTE:Because SOLIDWORKS PDM Professional cannot force a reload of
...
1. Start Microsoft Visual
  Studio or another version that supports debugging.
2. Click
