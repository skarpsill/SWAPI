---
title: "SetRandomVibrationGaussIntegrationOrder2 Method (ICWDynamicStudyOptions)"
project: "SOLIDWORKS Simulation API Help"
interface: "ICWDynamicStudyOptions"
member: "SetRandomVibrationGaussIntegrationOrder2"
kind: "method"
source: "cworksapi/SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWDynamicStudyOptions~SetRandomVibrationGaussIntegrationOrder2.html"
---

# SetRandomVibrationGaussIntegrationOrder2 Method (ICWDynamicStudyOptions)

Sets the Gauss integration order of the random vibration dynamic study.
...
```vb
Function SetRandomVibrationGaussIntegrationOrder2( _
...
value = instance.SetRandomVibrationGaussIntegrationOrder2(NPoints)
```

### C#

```csharp
System.int SetRandomVibrationGaussIntegrationOrder2(
   System.int NPoints
)
```
...
[CWDynamicStudyOptions::SetRandomVibrationGaussIntegrationOrder2](ms-its:cworksapivb6.chm::/CosmosWorksLib~CWDynamicStudyOptions~SetRandomVibrationGaussIntegrationOrder2.html)
