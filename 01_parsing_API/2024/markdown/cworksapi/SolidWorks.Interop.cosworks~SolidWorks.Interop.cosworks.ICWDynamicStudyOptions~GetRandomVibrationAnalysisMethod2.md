---
title: "GetRandomVibrationAnalysisMethod2 Method (ICWDynamicStudyOptions)"
project: "SOLIDWORKS Simulation API Help"
interface: "ICWDynamicStudyOptions"
member: "GetRandomVibrationAnalysisMethod2"
kind: "method"
source: "cworksapi/SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWDynamicStudyOptions~GetRandomVibrationAnalysisMethod2.html"
---

# GetRandomVibrationAnalysisMethod2 Method (ICWDynamicStudyOptions)

Gets the analysis method of the random vibration dynamic study.
...
```vb
Function GetRandomVibrationAnalysisMethod2( _
...
value = instance.GetRandomVibrationAnalysisMethod2(NMethod)
```

### C#

```csharp
System.int GetRandomVibrationAnalysisMethod2(
...
[CWDynamicStudyOptions::GetRandomVibrationAnalysisMethod2](ms-its:cworksapivb6.chm::/CosmosWorksLib~CWDynamicStudyOptions~GetRandomVibrationAnalysisMethod2.html)
