---
title: "ICWLoadsAndRestraints Interface Methods"
project: "SOLIDWORKS Simulation API Help"
interface: "ICWLoadsAndRestraints_methods"
member: ""
kind: "methods"
source: "cworksapi/SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWLoadsAndRestraints_methods.html"
---

# ICWLoadsAndRestraints Interface Methods

For a list of all members of this type, see[ICWLoadsAndRestraints members](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWLoadsAndRestraints_members.html).

## Public Methods

|  | Name | Description |
| --- | --- | --- |
| Method | GetDirection | Gets the direction of this load or restraint. |
| Method | GetEntityAt | Gets the entity at the specified index in this load or restraint. |
| Method | GetReferenceGeometry | Gets the entity used for reference geometry in this load or restraint. |
| Method | SuppressUnSuppress | Suppresses or unsuppresses the load or restraint depending on its state . |
