---
title: "ISwDMConfiguration Interface"
project: "SOLIDWORKS Document Manager API Help"
interface: "ISwDMConfiguration"
member: ""
kind: "interface"
source: "swdocmgrapi/SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration.html"
---

# ISwDMConfiguration Interface
...
```vb
Public Interface ISwDMConfiguration
```
...
```cpp
public interface class ISwDMConfiguration
```
...
[SwDMConfiguration](ms-its:swdocmgrapivb6.chm::/swdocumentmgr~SwDMConfiguration.html)
