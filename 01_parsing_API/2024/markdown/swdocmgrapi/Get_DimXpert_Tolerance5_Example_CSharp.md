---
title: "Get DimXpert Tolerance5 Example (C#)"
project: ""
interface: ""
member: ""
kind: "example"
source: "swdocmgrapi/Get_DimXpert_Tolerance5_Example_CSharp.htm"
---

# Get DimXpert Tolerance5 Example (C#)

This example builds a part to demonstrate usage of the SOLIDWORKS Document
Manager API for a DimXpertkadov_tag{{</spaces>}}concentricity
...
// kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}b. Click Boss1 (front extrusion).
// kadov_tag{{<spaces>}}   c. Click outside the part to place the annotation.
// kadov_tag{{<spaces>}}   d. Click the green check mark to accept Datum A.
// kadov_tag{{<spaces>}}   e. Click Geometric Tolerance on the DimXpert toolbar.
...
// kadov_tag{{<spaces>}}         kadov_tag{{</spaces>}}  vii.  Click OK to close the Geometric Tolerance Properties dialog.
// kadov_tag{{<spaces>}}   f. In the DimXpertManager tab of the Management Panel,
//       expand Simple Hole2.
// kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}g. Observe the following Dimxpert annotation: kadov_tag{{</spaces>}}Concentricity1.
