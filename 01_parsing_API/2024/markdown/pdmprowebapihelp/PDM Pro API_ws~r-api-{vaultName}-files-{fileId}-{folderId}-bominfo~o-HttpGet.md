---
title: "api/{vaultName}/files/{fileId}/{folderId}/bominfo (Get)"
project: ""
interface: "r-api-{vaultName}-files-{fileId}-{folderId}-bominfo"
member: "o-HttpGet"
kind: "topic"
source: "pdmprowebapihelp/PDM Pro API_ws~r-api-{vaultName}-files-{fileId}-{folderId}-bominfo~o-HttpGet.html"
---

# api/{vaultName}/files/{fileId}/{folderId}/bominfo (Get)

PDM Pro API Web Service

| Get | api/{vaultName}/files/{fileId}/{folderId}/bominfo |
| --- | --- |
...
| PDM Pro API Web Service > File Resource Group : api/{vaultName}/files/{fileId}/{folderId}/bominfo (Get) |
| --- |
