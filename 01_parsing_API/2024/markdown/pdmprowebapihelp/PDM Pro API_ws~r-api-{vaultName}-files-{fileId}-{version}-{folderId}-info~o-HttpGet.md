---
title: "api/{vaultName}/files/{fileId}/{version}/{folderId}/info (Get)"
project: ""
interface: "r-api-{vaultName}-files-{fileId}-{version}-{folderId}-info"
member: "o-HttpGet"
kind: "topic"
source: "pdmprowebapihelp/PDM Pro API_ws~r-api-{vaultName}-files-{fileId}-{version}-{folderId}-info~o-HttpGet.html"
---

# api/{vaultName}/files/{fileId}/{version}/{folderId}/info (Get)

PDM Pro API Web Service

| Get | api/{vaultName}/files/{fileId}/{version}/{folderId}/info |
| --- | --- |
...
| PDM Pro API Web Service > File Resource Group : api/{vaultName}/files/{fileId}/{version}/{folderId}/info (Get) |
| --- |
...
[
  {
    ...
    "Size": 3,
    "ModifiedDate": "2023-12-07T14:34:00.7468239-05:00",
    "Version": 5,
...
<ArrayOfObjectInfo xmlns:i="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://schemas.datacontract.org/2004/07/SWPDM.Models">
  <ObjectInfo>
    ...
    <ModifiedDate>2023-12-07T14:34:00.7468239-05:00</ModifiedDate>
