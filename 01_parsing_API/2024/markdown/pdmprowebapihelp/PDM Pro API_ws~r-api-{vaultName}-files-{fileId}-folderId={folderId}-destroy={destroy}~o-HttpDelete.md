---
title: "api/{vaultName}/files/{fileId}?folderId={folderId}&destroy={destroy} (Delete)"
project: ""
interface: "r-api-{vaultName}-files-{fileId}-folderId={folderId}-destroy={destroy}"
member: "o-HttpDelete"
kind: "topic"
source: "pdmprowebapihelp/PDM Pro API_ws~r-api-{vaultName}-files-{fileId}-folderId={folderId}-destroy={destroy}~o-HttpDelete.html"
---

# api/{vaultName}/files/{fileId}?folderId={folderId}&destroy={destroy} (Delete)

PDM Pro API Web Service

| Delete | api/{vaultName}/files/{fileId}?folderId={folderId}&destroy={destroy} |
| --- | --- |
...
| PDM Pro API Web Service > File Resource Group : api/{vaultName}/files/{fileId}?folderId={folderId}&destroy={destroy} (Delete) |
| --- |
