---
title: "api/{vaultName}/folders/{folderId} (Get)"
project: ""
interface: "r-api-{vaultName}-folders-{folderId}"
member: "o-HttpGet"
kind: "topic"
source: "pdmprowebapihelp/PDM Pro API_ws~r-api-{vaultName}-folders-{folderId}~o-HttpGet.html"
---

# api/{vaultName}/folders/{folderId} (Get)

PDM Pro API Web Service

| Get | api/{vaultName}/folders/{folderId} |
| --- | --- |
...
| PDM Pro API Web Service > Folder Resource Group : api/{vaultName}/folders/{folderId} (Get) |
| --- |
