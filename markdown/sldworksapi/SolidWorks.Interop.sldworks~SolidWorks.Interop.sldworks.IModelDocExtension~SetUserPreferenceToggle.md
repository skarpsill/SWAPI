---
title: "SetUserPreferenceToggle Method (IModelDocExtension)"
...
- `UserPref`: User preference as defined in[swUserPreferenceToggle_e](ms-its:swconst.chm::/SOLIDWORKS.Interop.swconst~SOLIDWORKS.Interop.swconst.swUserPreferenceToggle_e.html)
...
- `Value`: True to toggle UserPref on, false to toggle UserPref off
...
[ModelDocExtension::SetUserPreferenceToggle](ms-its:sldworksapivb6.chm::/sldworks~ModelDocExtension~SetUserPreferenceToggle.html)
