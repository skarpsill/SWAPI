---
title: "IEditDimensionProperties3 Method (IModelDoc2)"
project: "SOLIDWORKS API Help"
interface: "IModelDoc2"
member: "IEditDimensionProperties3"
kind: "method"
source: "sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~IEditDimensionProperties3.html"
---

# IEditDimensionProperties3 Method (IModelDoc2)

Obsolete. Superseded by

[IModelDocExtension::IEditDimensionProperties](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IModelDocExtension~IEditDimensionProperties.html)
...
- `TolMin`: Minimum value for the tolerance
- `TolMaxFit`: Text for the maximum FIT value when using a fit tolerance type
- `TolMinFit`: Text for the minimum FIT value when using a fit tolerance type<
- `UseDocPrec`: True to use the document's precision value, false to use the value specified for precision
- `Precision`: Precision value to use for this dimension if UseDocPrec is false
- `ArrowsIn`: Type of arrow to use on the first arrow of this dimension as defined in[swArrowStyle_e](ms-its:swconst.chm::/SOLIDWORKS.Interop.swconst~SOLIDWORKS.Interop.swconst.swArrowStyle_e.html)if UseDocArrows is falseParamDesc
- `UseDocArrows`: True to use the document's arrow types, false to use values specified for Arrow1 and Arrow2
- `Arrow1`: Type of arrow to use on the first arrow of this dimension as defined in
...
- `Arrow2`: Type of arrow to use on the secondarrow of this dimension as defined in[swArrowStyle_e](ms-its:swconst.chm::/SOLIDWORKS.Interop.swconst~SOLIDWORKS.Interop.swconst.swArrowStyle_e.html)if UseDocArrows is false
...
- `CenterText`: True if you want to center the text in the dimension, false if not
...
[ModelDoc2::IEditDimensionProperties3](ms-its:sldworksapivb6.chm::/sldworks~ModelDoc2~IEditDimensionProperties3.html)
...
[IModelDoc2::EditDimensionProperties3 Method](SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~EditDimensionProperties3.html)
