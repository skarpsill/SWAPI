---
title: "SetTextAtIndex Method (INote)"
...
. Sets the text value at the specified index within the compound note.
...
- `Index`: Index position of the text within the compound note; an invalid index value causes false to be returned
- `Txt`: Text to replace the current note text
...
[Note::SetTextAtIndex](ms-its:sldworksapivb6.chm::/sldworks~Note~SetTextAtIndex.html)
