---
title: "ICreatePlanePerCurveAndPassPoint3 Method (IModelDoc2)"
...
- `OrigAtCurve`: Truekadov_tag{{<spaces>}}kadov_tag{{</spaces>}}if you want the origin to be on the curve, false if not
- `AutoSize`: True if plane is to be automatically sized, false if not
...
[ModelDoc2::ICreatePlanePerCurveAndPassPoint3](ms-its:sldworksapivb6.chm::/sldworks~ModelDoc2~ICreatePlanePerCurveAndPassPoint3.html)
