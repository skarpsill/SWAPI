---
title: "InsertFreeform2 Method (IFeatureManager)"
project: "SOLIDWORKS API Help"
interface: "IFeatureManager"
member: "InsertFreeform2"
kind: "method"
source: "sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IFeatureManager~InsertFreeform2.html"
---
...
- `Nsided`: True to use the new Freeform algorithm, false to use the old one
...
- `Angle`: Value by which to rotate the U,V lines (in radians)

### Return Value

[Freeform feature](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IFeature.html)

## VBA Syntax

See

[FeatureManager::InsertFreeform2](ms-its:sldworksapivb6.chm::/sldworks~FeatureManager~InsertFreeform2.html)
