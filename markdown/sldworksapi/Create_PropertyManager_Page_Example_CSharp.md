...
//-------------------------------------------------------------------------
 // Preconditions:
 //  1 kadov_tag{{<spaces>}} kadov_tag{{</spaces>}}Create a C# macro named CreatePropertyManagerPageExample_CSharp.
 //  2. Copy and paste Main into  SolidWorksMacro.cs.
 //  3. Add a class named clsPropMgr and copy and paste  clsPropMgr into that class.
 //  4. Click Project > kadov_tag{{</spaces>}}Add Reference, browse to install_dir\api\redist\, select
 ...
 //  7. Replace the ImageList and ImageListMasks array elements
...
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}string PageTitle = null;
 ...
 kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}int options = 0;
...
kadov_tag{{<spaces>}}                kadov_tag{{</spaces>}}
 //Add two selection boxes
  kadov_tag{{</spaces>}}controlType = (int)swPropertyManagerPageControlType_e.swControlType_Selectionbox;
  kadov_tag{{</spaces>}}caption = "";
kadov_tag{{<spaces>}}                kadov_tag{{</spaces>}}
...
kadov_tag{{<spaces>}}                kadov_tag{{</spaces>}}pm_Selection.SingleEntityOnly = false;
 ...
 kadov_tag{{<spaces>}}                kadov_tag{{</spaces>}}pm_Selection2.SetSelectionFilters(filterObj);
                 ...
                 kadov_tag{{</spaces>}}//Add a combo box
...
kadov_tag{{<spaces>}}                kadov_tag{{</spaces>}}//Add a list box
 ...
 kadov_tag{{<spaces>}}
 kadov_tag{{</spaces>}}kadov_tag{{<spaces>}}                kadov_tag{{</spaces>}}if ((pm_List != null))
 kadov_tag{{<spaces>}}                kadov_tag{{</spaces>}}{
...
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}{
kadov_tag{{<spaces>}}                Debug.Print ("OK button clicked");
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}}
kadov_tag{{<spaces>}}        kadov_tag{{</spaces>}}}
