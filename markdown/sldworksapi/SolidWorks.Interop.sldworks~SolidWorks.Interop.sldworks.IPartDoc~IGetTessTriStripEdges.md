---
title: "IGetTessTriStripEdges Method (IPartDoc)"
...
- in-process, unmanaged C++: Pointer to an array of longs containing the list of edge IDs for this part document (see
