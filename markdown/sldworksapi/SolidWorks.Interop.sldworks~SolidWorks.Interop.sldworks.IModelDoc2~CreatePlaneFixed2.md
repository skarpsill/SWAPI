---
title: "CreatePlaneFixed2 Method (IModelDoc2)"
project: "SOLIDWORKS API Help"
interface: "IModelDoc2"
member: "CreatePlaneFixed2"
kind: "method"
source: "sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~CreatePlaneFixed2.html"
---

# CreatePlaneFixed2 Method (IModelDoc2)
...
- `UseGlobal`: Controls x-axis orientation (see**Remarks**)
...
or NULL if the creation of the plane failed

## VBA Syntax

See

[ModelDoc2::CreatePlaneFixed2](ms-its:sldworksapivb6.chm::/sldworks~ModelDoc2~CreatePlaneFixed2.html)
