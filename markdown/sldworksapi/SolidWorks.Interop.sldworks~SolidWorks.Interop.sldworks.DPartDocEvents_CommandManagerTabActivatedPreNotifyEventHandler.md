---
title: "DPartDocEvents_CommandManagerTabActivatedPreNotifyEventHandler Delegate (SolidWorks.Interop.sldworks)"
project: "SOLIDWORKS API Help"
interface: "DPartDocEvents_CommandManagerTabActivatedPreNotifyEventHandler"
member: ""
kind: "topic"
...
# DPartDocEvents_CommandManagerTabActivatedPreNotifyEventHandler Delegate (SolidWorks.Interop.sldworks)
...
[CommandManagerTabActivatedPreNotify Event (PartDoc)](ms-its:sldworksapivb6.chm::/SldWorks~PartDoc~CommandManagerTabActivatedPreNotify_EV.html)

.

## Remarks

If developing a C++ application, use[swPartCommandManagerTabActivatedPreNotify](ms-its:swconst.chm::/SOLIDWORKS.Interop.swconst~SOLIDWORKS.Interop.swconst.swPartNotify_e.html)to register for this notification.
