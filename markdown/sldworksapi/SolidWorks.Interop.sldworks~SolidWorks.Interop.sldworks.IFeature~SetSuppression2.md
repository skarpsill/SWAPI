---
title: "SetSuppression2 Method (IFeature)"
...
- `SuppressionState`: Suppression state as defined in
...
- `Config_names`: Array of configuration names; valid only if Config_opt set to swInConfigurationOpts_e.swSpecifyConfiguration
...
[Feature::SetSuppression2](ms-its:sldworksapivb6.chm::/sldworks~Feature~SetSuppression2.html)
