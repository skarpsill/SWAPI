---
title: "GetControlPoints Method (ISplineParamData)"
...
- `ControlPoints`: One-dimensional array of doubles (
...
[SplineParamData::GetControlPoints](ms-its:sldworksapivb6.chm::/sldworks~SplineParamData~GetControlPoints.html)
