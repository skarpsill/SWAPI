---
title: "Add Along Z Dimension to 3D Sketch Example (VBA)"
project: ""
interface: ""
member: ""
kind: "example"
source: "sldworksapi/Add_Along_Z_Dimension_To_3D_Sketch_Example_VB.htm"
---
...
```
    ...
    Set myDisplayDim = Part.SketchManager.AddAlongZDimension(-0.03841894197919, -0.03273212874668, 0.042510877252)
    Part.ClearSelection2 True
```
