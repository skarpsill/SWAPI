---
title: "IGetArcs2 Method (ISketch)"
...
- `ArraySize`: Number of arcs in the sketch

### Return Value

- in-process, unmanaged C++: Pointer to an array of doubles containing the arcs in the sketch (see
