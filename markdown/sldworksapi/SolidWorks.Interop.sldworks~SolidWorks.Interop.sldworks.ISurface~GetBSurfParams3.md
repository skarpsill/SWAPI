---
title: "GetBSurfParams3 Method (ISurface)"
...
- `WantCubic`: True if cubic is needed, false if not; specifying true converts any surface to a cubic B-spline surface
...
- `VP0`: [ISurfaceParameterizationData](SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.ISurfaceParameterizationData.html)
...
[Surface::GetBSurfParams3](ms-its:sldworksapivb6.chm::/sldworks~Surface~GetBSurfParams3.html)
