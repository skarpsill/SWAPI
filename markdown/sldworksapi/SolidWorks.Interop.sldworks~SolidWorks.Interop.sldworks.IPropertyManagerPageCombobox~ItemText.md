---
title: "ItemText Property (IPropertyManagerPageCombobox)"
...
- `Item`: Position of the item where to get the text in the 0-based list of items or -1 to get the text of the currently selected item
...
[PropertyManagerPageCombobox::ItemText](ms-its:sldworksapivb6.chm::/sldworks~PropertyManagerPageCombobox~ItemText.html)
