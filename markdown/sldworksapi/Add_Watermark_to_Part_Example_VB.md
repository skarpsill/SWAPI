---
title: "Add Watermark to Part Example (VBA)"
project: ""
interface: ""
member: ""
kind: "example"
source: "sldworksapi/Add_Watermark_to_Part_Example_VB.htm"
---

# Add Watermark to Part Example (VBA)
...
```
    ...
    Set swNote = swSelectionMgr.GetSelectedObject6(1, 0)
