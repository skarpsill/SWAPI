---
title: "ViewZoomToSelection Method (IModelDoc2)"
project: "SOLIDWORKS API Help"
interface: "IModelDoc2"
member: "ViewZoomToSelection"
kind: "method"
source: "sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IModelDoc2~ViewZoomToSelection.html"
---

# ViewZoomToSelection Method (IModelDoc2)
...
[ModelDoc2::ViewZoomToSelection](ms-its:sldworksapivb6.chm::/sldworks~ModelDoc2~ViewZoomToSelection.html)

.

## Examples

[Copy and Paste Feature (C#)](Copy_and_Paste_Feature_Example_CSharp.htm)

[Copy and Paste Feature (VB.NET)](Copy_and_Paste_Feature_Example_VBNET.htm)

[Copy and Paste Feature (VBA)](Copy_and_Paste_Feature_Example_VB.htm)
