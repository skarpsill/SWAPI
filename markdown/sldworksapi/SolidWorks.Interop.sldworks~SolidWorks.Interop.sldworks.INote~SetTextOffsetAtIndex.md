---
title: "SetTextOffsetAtIndex Method (INote)"
project: "SOLIDWORKS API Help"
interface: "INote"
member: "SetTextOffsetAtIndex"
kind: "method"
source: "sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.INote~SetTextOffsetAtIndex.html"
---
...
- `Index`: Index number of the text to relocate.
- `X`: X location for the piece of text
- `Y`: Y location for the piece of text
- `Z`: Z location for the piece of text

## VBA Syntax

See

[Note::SetTextOffsetAtIndex](ms-its:sldworksapivb6.chm::/sldworks~Note~SetTextOffsetAtIndex.html)
