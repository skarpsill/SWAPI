...
member: ""
kind: "example"
source: "swdimxpertapi/Get_DimXpert_Tolerance6_Example_VBNET.htm"
---
...
' 2. kadov_tag{{<spaces>}}Open the DimXpert toolbar from View > Toolbars.
'
' Create a composite surface profile geometric tolerance:
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}} 1. Click Datum on the DimXpert tool bar.
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}} 2. Click a top face of the part.
'  kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}3. Click to place Datum A.
' kadov_tag{{<spaces>}} 4. Click a back face of the part.
'  kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}5. Click to place Datum B.
'  kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}6. Click a side face of the part.
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}} 7. Click to place Datum C.
' kadov_tag{{<spaces>}} 8. Click Geometric Tolerance of the DimXpert tool bar.
' kadov_tag{{<spaces>}} 9. kadov_tag{{</spaces>}}In the Geometric Tolerance Properties dialog:
' kadov_tag{{<spaces>}}    a. Select Surface Profile from the Symbol dropdown.
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}} b. Enter A in Primary, B in Secondary, and
'        in Tertiary.
' kadov_tag{{<spaces>}}    kadov_tag{{</spaces>}}c. In the second row, select Profile of Surface from the Symbol dropdown.
' kadov_tag{{<spaces>}}    d. In the second row, type A in Primary.
' kadov_tag{{<spaces>}}    e. Select the Composite frame check box.
' kadov_tag{{<spaces>}}    f. Click the front curve of the hook.
' kadov_tag{{<spaces>}}    kadov_tag{{</spaces>}}g. Click to place the annotation.
' kadov_tag{{<spaces>}}    h. Click OK to close the Geometric Tolerance Properties dialog.
' kadov_tag{{<spaces>}}10. In the DimXpertManager tab of the Management Panel, expand Cylinder1.
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}11. Observe the following Dimxpert annotation: kadov_tag{{<spaces>}} kadov_tag{{</spaces>}}Composite Surface Profile1
'
' Create tangency geometric tolerances:
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}} 1. Click Auto Dimension Scheme.
'  kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}2. Select all feature filters.
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}} 3. Click onthe green check mark to accept the settings.
'  kadov_tag{{<spaces>}}4. Observe several tangency tolerance annotations.
'
' Before running this macro:
' kadov_tag{{<spaces>}} 1. Ensure that the SolidWorks.Interop.swdimxpert.dll interop assembly
'     is loaded (right-click on the project name in the Project Explorer,
'     click Add Reference > .NET tab).
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}} 2. Ensure that the Microsoft Scripting Runtime library is loaded
' kadov_tag{{<spaces>}}    (right-click on the project name in the Project Explorer, click
...
kadov_tag{{<spaces>}}        kadov_tag{{</spaces>}}strs.Add(" kadov_tag{{<spaces>}} kadov_tag{{</spaces>}}Tolerance: " + FormatDouble(annotation.Tolerance))
kadov_tag{{<spaces>}}    kadov_tag{{</spaces>}}End Sub
kadov_tag{{<spaces>}}    kadov_tag{{</spaces>}}Private Sub TangencyData(ByVal annotation As DimXpertTangencyTolerance)
kadov_tag{{<spaces>}}        kadov_tag{{</spaces>}}strs.Add("")
kadov_tag{{<spaces>}}        kadov_tag{{</spaces>}}strs.Add("Tangency Tolerance Compartment")
kadov_tag{{<spaces>}}        kadov_tag{{</spaces>}}strs.Add("Origin feature: kadov_tag{{<spaces>}} kadov_tag{{</spaces>}}" + annotation.OriginFeature.Name)
kadov_tag{{<spaces>}}        kadov_tag{{</spaces>}}' the tolerance value
kadov_tag{{<spaces>}}        kadov_tag{{</spaces>}}strs.Add(" kadov_tag{{<spaces>}} kadov_tag{{</spaces>}}Tolerance: " + FormatDouble(annotation.Tolerance))
kadov_tag{{<spaces>}}    kadov_tag{{</spaces>}}End Sub
