---
title: "IDimXpertIntersectPlaneFeature Interface"
project: "SOLIDWORKS DimXpert API Help"
interface: "IDimXpertIntersectPlaneFeature"
member: ""
kind: "interface"
source: "swdimxpertapi/SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertIntersectPlaneFeature.html"
---

# IDimXpertIntersectPlaneFeature Interface

Allows you to access specific information about DimXpert intersect planes on the DimXpertManager tab of the Management Panel.
...
```vb
Public Interface IDimXpertIntersectPlaneFeature
```
...
```cpp
public interface class IDimXpertIntersectPlaneFeature
```
...
[DimXpertIntersectPlaneFeature](ms-its:swdimxpertapivb6.chm::/swdimxpert~DimXpertIntersectPlaneFeature.html)
