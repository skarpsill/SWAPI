---
title: "IDimXpertSymmetryTolerance Interface"
project: "SOLIDWORKS DimXpert API Help"
interface: "IDimXpertSymmetryTolerance"
member: ""
kind: "interface"
source: "swdimxpertapi/SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertSymmetryTolerance.html"
---

# IDimXpertSymmetryTolerance Interface

Allows you to access DimXpert symmetry tolerances.
...
```vb
Public Interface IDimXpertSymmetryTolerance
```
...
```cpp
public interface class IDimXpertSymmetryTolerance
```
...
[DimXpertSymmetryTolerance](ms-its:swdimxpertapivb6.chm::/swdimxpert~DimXpertSymmetryTolerance.html)
