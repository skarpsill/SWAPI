---
title: "IDimXpertFilletFeature Interface"
project: "SOLIDWORKS DimXpert API Help"
interface: "IDimXpertFilletFeature"
member: ""
kind: "interface"
source: "swdimxpertapi/SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertFilletFeature.html"
---

# IDimXpertFilletFeature Interface

Allows you to access specific information about DimXpert fillets on the DimXpertManager tab of the Management Panel.
...
```vb
Public Interface IDimXpertFilletFeature
```
...
```cpp
public interface class IDimXpertFilletFeature
```
...
[DimXpertFilletFeature](ms-its:swdimxpertapivb6.chm::/swdimxpert~DimXpertFilletFeature.html)
