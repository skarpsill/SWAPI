---
title: "Get DimXpert Tolerance4 Example (VBA)"
project: ""
interface: ""
member: ""
kind: "example"
source: "swdimxpertapi/Get_DimXpert_Tolerance4_Example_VB.htm"
---

# Get DimXpert Tolerance4 Example (VBA)
...
'----------------------------------------------------------------------------
' Preconditions:
' 1. kadov_tag{{<spaces>}}kadov_tag{{</spaces>}} Open public_documents\samples\tutorial\api\plate_tolstatus.sldprt.
' 2. kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}Open the DimXpert toolbar from View > Toolbars.

' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}Create the chamfer dimension tolerance:
' kadov_tag{{<spaces>}}1. Click Auto Dimension Scheme on the DimXpert toolbar.
' kadov_tag{{<spaces>}}2. Ensure that the Chamfer feature filter is selected.
' kadov_tag{{<spaces>}}3. Click the green arrow to accept the settings.
' kadov_tag{{<spaces>}}4. Observe ChamferDepth1 and ChamferDepth2 annotations in the DimXpert tree.
'
' Create angle-between dimension tolerance:
' kadov_tag{{<spaces>}}1. Click Location Dimension on the DimXpert toolbar.
' kadov_tag{{<spaces>}}2. Click a face of the part.
' kadov_tag{{<spaces>}}3. Click a face perpendicular to the face selected in step 2
'    (not the chamfer).
' kadov_tag{{<spaces>}}4. Click to place the annotation.
' kadov_tag{{<spaces>}}5. Find this Dimxpert annotation in the DimXpert tree: kadov_tag{{<spaces>}} kadov_tag{{</spaces>}}AngleBetween1.
'
' Create line profile and straightness tolerances:
' kadov_tag{{<spaces>}}1. Click Geometric Tolerance on the DimXpert toolbar.
' kadov_tag{{<spaces>}}2. kadov_tag{{</spaces>}}In the Geometric Tolerance Properties dialog:
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}a. Select Straightness in Symbol.
' kadov_tag{{<spaces>}}   b. In second row, select Profile of Line in Symbol.
' kadov_tag{{<spaces>}}   c. Type 0.25 in Tolerance 1.
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}d. Click the top face of the part.
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}e. Click to place the annotation.
' kadov_tag{{<spaces>}}   f. Click OK to close the Geometric Tolerance Properties dialog.
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}3. In the DimXpertManager tab of the Management Panel, expand Plane7.
' kadov_tag{{<spaces>}}4. Observe the following Dimxpert annotations: kadov_tag{{<spaces>}} kadov_tag{{</spaces>}}LineProfile1 and Straightness1
'
' Before running this macro:
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}1. Ensure that the SOLIDWORKS DimXpert type library is loaded
'    in Tools > References.
' kadov_tag{{<spaces>}}2. Ensure that the Microsoft Scripting Runtime library is loaded
'    in Tools > References.
'
' Postconditions:
...
'
' kadov_tag{{<spaces>}}NOTE: Because this part is used elsewhere, do not save changes.
'--------------------------------------------------
Option Explicit
...
kadov_tag{{<spaces>}}        kadov_tag{{</spaces>}}Dim chamfer As DimXpertChamferDimTol
kadov_tag{{<spaces>}}        kadov_tag{{</spaces>}}Set chamfer = annotation
kadov_tag{{<spaces>}}        kadov_tag{{</spaces>}}Select Case chamfer.ChamferType
...
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}strs.Add ("Chamfer Dimension Type: Linear Distance 1")
kadov_tag{{<spaces>}}        kadov_tag{{</spaces>}}Case swDimXpertChamferDimensionType_LinearDistance2
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}strs.Add ("Chamfer Dimension Type: Linear Distance 2")
kadov_tag{{<spaces>}}        kadov_tag{{</spaces>}}End Select
kadov_tag{{<spaces>}}        kadov_tag{{</spaces>}}
