---
title: "IDimXpertCompositeDistanceBetweenDimTol Interface"
project: "SOLIDWORKS DimXpert API Help"
interface: "IDimXpertCompositeDistanceBetweenDimTol"
member: ""
kind: "interface"
source: "swdimxpertapi/SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertCompositeDistanceBetweenDimTol.html"
---

# IDimXpertCompositeDistanceBetweenDimTol Interface

Allows you to access DimXpert composite distance-between dimension tolerances.
...
```vb
Public Interface IDimXpertCompositeDistanceBetweenDimTol
```
...
```cpp
public interface class IDimXpertCompositeDistanceBetweenDimTol
```
...
[DimXpertCompositeDistanceBetweenDimTol](ms-its:swdimxpertapivb6.chm::/swdimxpert~DimXpertCompositeDistanceBetweenDimTol.html)
...
You can access more general DimXpert feature information using
