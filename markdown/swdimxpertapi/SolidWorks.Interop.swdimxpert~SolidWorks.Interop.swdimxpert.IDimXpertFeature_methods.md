---
title: "IDimXpertFeature Interface Methods"
project: "SOLIDWORKS DimXpert API Help"
interface: "IDimXpertFeature_methods"
member: ""
kind: "methods"
source: "swdimxpertapi/SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertFeature_methods.html"
---

# IDimXpertFeature Interface Methods

For a list of all members of this type, see[IDimXpertFeature members](SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertFeature_members.html).

## Public Methods

|  | Name | Description |
| --- | --- | --- |
| Method | GetAppliedAnnotationCount | Gets the number of annotations applied to this DimXpert feature. |
| Method | GetAppliedAnnotations | Gets all of the annotations applied to this DimXpert feature. |
| Method | GetAppliedFeatureCount | Gets the number of features that this DimXpert feature applies to. |
| Method | GetAppliedFeatures | Gets all of the features that this DimXpert feature applies to. |
| Method | GetFaceCount | Gets the number of SOLIDWORKS faces in this DimXpert feature. |
| Method | GetFaces | Gets the SOLIDWORKS faces in this DimXpert feature. |
| Method | GetModelFeature | Gets the SOLIDWORKS model feature corresponding to this DimXpert feature. |
| Method | IGetAppliedAnnotations | Gets all of the annotations applied to this DimXpert feature. |
| Method | IGetAppliedFeatures | Gets all of the features that this DimXpert feature applies to. |
| Method | IGetFaces | Gets the SOLIDWORKS faces in this DimXpert feature. |
| Method | IsCombinedAnnotation | Gets whether the pre-selected annotation is combined or not. |
| Method | IsSuppressed | Gets whether this DimXpert feature is suppressed from the view in the model. |
| Method | SetCombineAnnotation | Sets whether the pre-selected annotation is a combined annotation. |
