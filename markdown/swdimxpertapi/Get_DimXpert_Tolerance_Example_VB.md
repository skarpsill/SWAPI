---
title: "Get DimXpert Tolerance Example (VBA)"
project: ""
interface: ""
member: ""
kind: "example"
...
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}} 4. Ensure that all feature filters are selected.
...
'     Management Panel.
' kadov_tag{{<spaces>}} 7. Observe the following Dimxpert annotations: kadov_tag{{<spaces>}} kadov_tag{{</spaces>}}Counterbore3 and Depth3
' kadov_tag{{<spaces>}} 8. Open an Immediate window.
'  kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}9. Ensure that the latest SOLIDWORKS DimXpert type library is loaded
'     in Tools > References.
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}10. Ensure that the Microsoft Scripting Runtime library is loaded
'     in Tools > References.
...
'
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}NOTE: Because these parts are used elsewhere, do not save changes.
'--------------------------------------------------
Option Explicit
