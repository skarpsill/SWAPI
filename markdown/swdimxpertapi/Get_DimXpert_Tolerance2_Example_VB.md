---
title: "Get DimXpert Tolerance2 Example (VBA)"
project: ""
interface: ""
member: ""
kind: "example"
source: "swdimxpertapi/Get_DimXpert_Tolerance2_Example_VB.htm"
---

# Get DimXpert Tolerance2 Example (VBA)
...
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}3. Select Create Compound Plane from the DimXpert shortcut toolbar.
...
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}6. Click the back face of the block to complete the location dimension.
' kadov_tag{{<spaces>}}7. Click to position the location dimension.
' 8. Press Esc to end dimensioning.
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}9. Observe the following Dimxpert annotations: kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}DistanceBetween1
...
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}2. Select Part type ofkadov_tag{{<spaces>}} kadov_tag{{</spaces>}}Prismatic.
' kadov_tag{{<spaces>}}3. Select Tolerance type ofkadov_tag{{<spaces>}} kadov_tag{{</spaces>}}Plus and Minus.
...
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}1. Click Datum on the DimXpert toolbar.
' kadov_tag{{<spaces>}}2. Click the face in front of the left hole and click
'    to place Datum A.
' kadov_tag{{<spaces>}}3. Click the green check mark to finish the Datum definition.
...
' kadov_tag{{<spaces>}}   a. Select Symmetry from the Symbol dropdown.
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}b. Type A for Primary Datum.
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}c. Click the face in front of the right hole.
...
' kadov_tag{{<spaces>}}1. Open an Immediate window.
' kadov_tag{{<spaces>}}2. Ensure that the SOLIDWORKS DimXpert type library is loaded
'    in Tools > References.
' kadov_tag{{<spaces>}}3. Ensure that the Microsoft Scripting Runtime library is loaded
'    in Tools > References.
'
' Postconditions:
' kadov_tag{{<spaces>}}1. Writes the output to c:\temp\dimXpertInfo.txt.
' 2. kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}Inspect the Immediate Window.
'
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}NOTE: Because the part is used elsewhere, do not save changes.
'---------------------------------------------------------------------------
Option Explicit
Dim strs As New Collection
Dim dimXpertPart As SwDimXpert.dimXpertPart
Dim patternTreatment As swDimXpertPatternTreatmentType_e
...
ElseIf annoType = swDimXpertDimTol_Radius Then
kadov_tag{{<spaces>}}        kadov_tag{{</spaces>}}Dim radiusDim As IDimXpertRadiusDimTol
kadov_tag{{<spaces>}}        kadov_tag{{</spaces>}}Set radiusDim = annotation
...
kadov_tag{{<spaces>}}         kadov_tag{{</spaces>}}If patternTreatment = swDimXpertPatternTreatmentType_unknown Then
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}strs.Add ("Pattern Treatment: unknown")
kadov_tag{{<spaces>}}         kadov_tag{{</spaces>}}ElseIf patternTreatment = swDimXpertPatternTreatmentType_CircularPattern Then
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}strs.Add ("Pattern Treatment: Circular pattern")
kadov_tag{{<spaces>}}         kadov_tag{{</spaces>}}ElseIf patternTreatment = swDimXpertPatternTreatmentType_IndividualFeatures Then
kadov_tag{{<spaces>}}            kadov_tag{{</spaces>}}strs.Add ("Pattern Treatment: Individual features")
kadov_tag{{<spaces>}}        kadov_tag{{</spaces>}}End If
kadov_tag{{<spaces>}}        kadov_tag{{</spaces>}}
kadov_tag{{<spaces>}} kadov_tag{{</spaces>}}ElseIf annoType = swDimXpertDimTol_Diameter Then
kadov_tag{{<spaces>}}      kadov_tag{{</spaces>}}Dim diaDim As IDimXpertDiameterDimTol
kadov_tag{{<spaces>}}        kadov_tag{{</spaces>}}Set diaDim = annotation
