---
title: "IDimXpertCompositePositionTolerance Interface"
project: "SOLIDWORKS DimXpert API Help"
interface: "IDimXpertCompositePositionTolerance"
member: ""
kind: "interface"
source: "swdimxpertapi/SolidWorks.Interop.swdimxpert~SolidWorks.Interop.swdimxpert.IDimXpertCompositePositionTolerance.html"
---

# IDimXpertCompositePositionTolerance Interface

Allows you to access DimXpert composite position tolerances.
...
```vb
Public Interface IDimXpertCompositePositionTolerance
```
...
```cpp
public interface class IDimXpertCompositePositionTolerance
```
...
[DimXpertCompositePositionTolerance](ms-its:swdimxpertapivb6.chm::/swdimxpert~DimXpertCompositePositionTolerance.html)
