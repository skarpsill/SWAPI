---
title: "BlockInstance::GetAttributes"
project: ""
interface: ""
member: ""
kind: "topic"
...
by[SketchBlockInstance::GetAttributes](sldworksAPI.chm::/SketchBlockInstance/SketchBlockInstance__GetAttributes.htm).
...
<param name="_CURRENTFILEPATH" value="C:\cheryle\APIHelp\sw2007\obsoleteapi\BlockInstance\BlockInstance__GetAttributes.htm" >
...
<param name="ControlLabel" value="See Also" >
<param name="UseIcon" value="0" >
<param name="Items" value="BlockInstance_Object$$**$$Note_Object$$**$$BlockInstanceAttribute$$**$$" >
<param name="Image" value="" >
<param name="FontInfo" value="MS Sans Serif,8,0,," >
<param name="_CURRENTFILEPATH" value="C:\cheryle\APIHelp\sw2007\obsoleteapi\BlockInstance\BlockInstance__GetAttributes.htm" >
...
<param name="ControlLabel" value="See Also" >
<param name="UseIcon" value="0" >
<param name="Items" value="EXBlocks$$**$$EXChangeAttributesBlockInstance$$**$$" >
<param name="Image" value="" >
<param name="FontInfo" value="MS Sans Serif,8,0,," >
<param name="_CURRENTFILEPATH" value="C:\cheryle\APIHelp\sw2007\obsoleteapi\BlockInstance\BlockInstance__GetAttributes.htm" >
