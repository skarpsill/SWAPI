---
title: "Surface::ICreateTrimmedSheet3"
project: ""
interface: ""
member: ""
kind: "topic"
...
| Input: | (long) NCurves | Number of curves in the array
of curves |
| --- | --- | --- |
| Input: | (LPCURVE) Curves | Array of curves that represent
the boundary of the sheet |
| Output: | (LPBODY2) Sheet | Pointer to the newly created
sheet body |
...
<param name="_CURRENTFILEPATH" value="C:\cheryle\APIHelp\sw2006\sldworksapi\Surface\Surface__ICreateTrimmedSheet3.htm" >
...
<param name="ControlLabel" value="See Also" >
<param name="UseIcon" value="0" >
<param name="Items" value="Surface_Object$$**$$Curve_Object$$**$Body2_Object$$**$$" >
<param name="Image" value="" >
<param name="FontInfo" value="MS Sans Serif,8,0,," >
<param name="_CURRENTFILEPATH" value="C:\cheryle\APIHelp\sw2006\sldworksapi\Surface\Surface__ICreateTrimmedSheet3.htm" >
