---
title: "PartDoc::GetCorrespondingEntity"
project: ""
interface: ""
member: ""
kind: "topic"
...
by[ModelDocExtension::GetCorrespondingEntity](sldworksAPI.chm::/ModelDocExtension/ModelDocExtension__GetCorrespondingEntity.htm).
...
| Input: | (LPENTITY) pEntity | Pointer to Entity object of
a vertex, face, or edge |
| --- | --- | --- |
...
<param name="_CURRENTFILEPATH" value="C:\cheryle\APIHelp\sw2007\obsoleteapi\PartDoc\PartDoc__GetCorrespondingEntity.htm" >
...
<param name="ControlLabel" value="See Also" >
<param name="UseIcon" value="0" >
<param name="Items" value="PartDoc_Object$$**$$Entity_Object$$**$$ZGetCorrespondingObjects$$**$$" >
<param name="Image" value="" >
<param name="FontInfo" value="MS Sans Serif,8,0,," >
<param name="_CURRENTFILEPATH" value="C:\cheryle\APIHelp\sw2007\obsoleteapi\PartDoc\PartDoc__GetCorrespondingEntity.htm" >
...
<param name="ControlLabel" value="See Also" >
<param name="UseIcon" value="0" >
<param name="Items" value="EXOpenPartFromAssembly$$**$$EXSelectModelFacesAssembly$$**$$" >
<param name="Image" value="" >
<param name="FontInfo" value="MS Sans Serif,8,0,," >
<param name="_CURRENTFILEPATH" value="C:\cheryle\APIHelp\sw2007\obsoleteapi\PartDoc\PartDoc__GetCorrespondingEntity.htm" >
