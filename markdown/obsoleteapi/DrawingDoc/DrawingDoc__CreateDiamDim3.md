---
title: "DrawingDoc::CreateDiamDim3"
project: ""
interface: ""
member: ""
kind: "topic"
...
by[DrawingDoc::CreateDiamDim4](sldworksAPI.chm::/DrawingDoc/DrawingDoc__CreateDiamDim4.htm).
...
| Return: | (LPDISPATCH)retval | Dispatch
pointer for the display dimension created |
...
| Input: | (double*)
P0 | Pointer
to an array of 3 doubles (x,y,z), Location of text |
| Input: | (double*)
P1 | Pointer
to an array of 3 doubles (x,y,z), Nearest point on circle |
| Input: | (double*)
P2 | Pointer
to an array of 3 doubles (x,y,z), Farthest point on circle diametrically
opposite to vP1 |
| Input: | (double*)
P3 | Pointer
...
| Output: | (LPDISPLAYDIMENSION)retval | Pointer
to the display dimension created |
...
<param name="_CURRENTFILEPATH" value="D:\APIHelp\sw2004\obsoleteapi\DrawingDoc\DrawingDoc__CreateDiamDim3.htm" >
