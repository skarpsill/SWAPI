...
by[View::GetDimensionInfo6](sldworksAPI.chm::/View/View__GetDimensionInfo6.htm).
...
in the array will be (1 +dimensionCount* 51).
...
arrowsOut= BOOLEANkadov_tag{{<spaces>}}kadov_tag{{</spaces>}}returned
...
thedimValuereturned is the
diameter value; if FALSE, then thedimValuereturned is the radial value.
...
<param name="_CURRENTFILEPATH" value="D:\APIHelp\sw2005\obsoleteapi\View\View__GetDimensionInfo5.htm" >
