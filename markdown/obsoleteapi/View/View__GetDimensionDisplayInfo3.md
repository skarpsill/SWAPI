---
title: "View::GetDimensionDisplayInfo3"
project: ""
interface: ""
member: ""
kind: "topic"
source: "obsoleteapi/View/View__GetDimensionDisplayInfo3.htm"
---

# View::GetDimensionDisplayInfo3

This method is obsolete and has been superseded
by[View::GetDimensionDisplayInfo4](View__GetDimensionDisplayInfo4.htm).
...
retval = View.GetDimensionDisplayInfo3
()
...
status = View->IGetDimensionDisplayInfo3
( retval )
...
For COM implementation, call View::GetDimensionCount3 to determine the
overall size of the array needed. The maximum number of doubles contained
in the array will be (dimensionCount* 173 + 1).
...
tolType=
tolerance type as defined in swTolType_e enumeration.
...
<param name="_CURRENTFILEPATH" value="D:\APIHelp\sw2005\obsoleteapi\View\View__GetDimensionDisplayInfo3.htm" >
