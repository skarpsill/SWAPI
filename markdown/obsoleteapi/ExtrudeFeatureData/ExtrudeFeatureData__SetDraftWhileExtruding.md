---
title: "ExtrudeFeatureData::SetDraftWhileExtruding"
project: ""
interface: ""
member: ""
kind: "topic"
...
void ExtrudeFeatureData.SetDraftWhileExtruding (forward, draftWhileExtrude)
...
reverse |
| --- | --- | --- |
| Input: | (BOOL) draftWhileExtrude | TRUE if feature is drafted while extruding, FALSE
if not |
...
reverse |
| --- | --- | --- |
| Input: | (VARIANT_BOOL) draftWhileExtrude | TRUE if feature is drafted while extruding, FALSE
if not |
...
<param name="_CURRENTFILEPATH" value="C:\Home\Oneill\sw2003\ExtrudeFeatureData\ExtrudeFeatureData__SetDraftWhileExtruding.htm" >
