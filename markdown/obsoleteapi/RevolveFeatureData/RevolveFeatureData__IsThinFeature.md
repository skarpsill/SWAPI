---
title: "RevolveFeatureData::IsThinFeature"
project: ""
interface: ""
member: ""
kind: "topic"
...
| Return: | (BOOL) isThinFeature | TRUE if revolution is a thin feature, FALSE if
not |
| --- | --- | --- |
...
| Output: | (VARIANT_BOOL) isThinFeature | TRUE if revolution is a thin feature, FALSE if
not |
| --- | --- | --- |
...
<param name="_CURRENTFILEPATH" value="C:\Home\obsoleteapi\RevolveFeatureData\RevolveFeatureData__IsThinFeature.htm" >
