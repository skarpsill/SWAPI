---
title: "Configuration::GetCustomProperties"
project: ""
interface: ""
member: ""
kind: "topic"
...
| Output: | (VARIANT) propTypes | Array of property types as defined in swCustomInfoType_e |
...
| Output: | (long*) propTypes | Pointer to an array of property types as defined in swCustomInfoType_e |
...
<param name="_CURRENTFILEPATH" value="C:\cheryle\APIHelp\sw2007\obsoleteapi\Configuration\Configuration__GetCustomProperties.htm" >
...
<param name="ControlLabel" value="See Also" >
<param name="UseIcon" value="0" >
<param name="Items" value="Configuration$$**$$" >
<param name="Image" value="" >
<param name="FontInfo" value="MS Sans Serif,8,0,," >
<param name="_CURRENTFILEPATH" value="C:\cheryle\APIHelp\sw2007\obsoleteapi\Configuration\Configuration__GetCustomProperties.htm" >
...
<param name="ControlLabel" value="See Also" >
<param name="UseIcon" value="0" >
<param name="Items" value="EXGetCustomProperties$$**$$" >
<param name="Image" value="" >
<param name="FontInfo" value="MS Sans Serif,8,0,," >
<param name="_CURRENTFILEPATH" value="C:\cheryle\APIHelp\sw2007\obsoleteapi\Configuration\Configuration__GetCustomProperties.htm" >
