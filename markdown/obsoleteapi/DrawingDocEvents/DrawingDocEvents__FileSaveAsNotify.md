---
title: "FileSaveAsNotify - DrawingDoc Event"
project: ""
interface: ""
member: ""
kind: "topic"
...
by the DrawingDoc event[FileSaveAsNotify2](sldworksAPI.chm::/DrawingDocEvents/DrawingDocEvents__FileSaveAsNotify2.htm).
...
When a user selectsFile,Savefor a document that has never
been saved, SolidWorks generates FileSaveAsNotify instead of FileSaveNotify.Return S_FALSE to stop
...
<param name="_CURRENTFILEPATH" value="C:\Home\sw2004\obsoleteapi\DrawingDocEvents\DrawingDocEvents__FileSaveAsNotify.htm" >
