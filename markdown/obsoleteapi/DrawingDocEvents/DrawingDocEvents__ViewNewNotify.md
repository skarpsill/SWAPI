---
title: "ViewNewNotify - DrawingDoc Event"
project: ""
interface: ""
member: ""
kind: "topic"
...
This
event is obsolete and has been superseded by the DrawingDoc event[ViewNewNotify2](sldworksAPI.chm::/DrawingDocEvents/DrawingDocEvents__ViewNewNotify2.htm).
...
when the user selectsWindow,New Window, or uses the splitter
...
<param name="_CURRENTFILEPATH" value="D:\APIHelp\sw2003\DrawingDocEvents\DrawingDocEvents__ViewNewNotify.htm" >
