...
status = Simulation->get_Timestamp
( &Retval )
...
| Output: | (long) Retval | Time stamp for this Physical Simulation
(see Remarks ) |
| --- | --- | --- |
...
<param name="_CURRENTFILEPATH" value="C:\cheryle\APIHelp\sw2008\obsoleteapi\Simulation\Simulation__Timestamp.htm" >
