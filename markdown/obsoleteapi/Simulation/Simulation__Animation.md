...
Animation object without playing the animation or displaying theAnimation Controllerpop-up toolbar.
...
status = Simulation->get_Animation
( &Retval )
...
NOTE:Use only the following Animation property and method with Simulution::Animation:
...
<param name="_CURRENTFILEPATH" value="C:\cheryle\APIHelp\sw2008\obsoleteapi\Simulation\Simulation__Animation.htm" >
