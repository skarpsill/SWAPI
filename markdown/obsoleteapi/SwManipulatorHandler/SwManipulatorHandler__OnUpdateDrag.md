---
title: "SwManipulatorHandler::OnUpdateDrag"
project: ""
interface: ""
member: ""
kind: "topic"
...
by[SwManipulatorHandler2::OnUpdateDrag](sldworksAPI.chm::/SwManipulatorHandler2/SwManipulatorHandler2__OnUpdateDrag.htm).
...
object |
| --- | --- | --- |
| Input: | (int) handleIndex | Control point's handle as defined
by swTriadManipulatorControlPoints_e |
| Input: | (LPDISPATCH) newPosMathPt | Dispatch pointer to the MathPoint
object indicating the pointer's new position |
...
| Input: | (int) handleIndex | Control point's handle as defined
by swTriadManipulatorControlPoints_e |
| Input: | (LPDISPATCH) newPosMathPt | Dispatch pointer to the MathPoint object indicating
...
<param name="_CURRENTFILEPATH" value="C:\cheryle\APIHelp\sw2007\obsoleteapi\SwManipulatorHandler\SwManipulatorHandler__OnUpdateDrag.htm" >
