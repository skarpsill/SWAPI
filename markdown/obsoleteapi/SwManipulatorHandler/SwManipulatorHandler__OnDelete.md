---
title: "SwManipulatorHandler::OnDelete"
project: ""
interface: ""
member: ""
kind: "topic"
...
by[SwManipulatorHandler2::OnDelete](sldworksAPI.chm::/SwManipulatorHandler2/SwManipulatorHandler2__OnDelete.htm).
...
object |
| --- | --- | --- |
| Output: | (VARIANT_BOOL) retVal | TRUE if the add-in application
deletes the manipulator, FALSE if not |
...
| --- | --- | --- |
| Output: | (VARIANT_BOOL) retVal | TRUE if the add-in application deletes the manipulator,
FALSE if not |
...
<param name="_CURRENTFILEPATH" value="C:\cheryle\APIHelp\sw2007\obsoleteapi\SwManipulatorHandler\SwManipulatorHandler__OnDelete.htm" >
