...
| Input: | (VARIANT_BOOL) wantCubic | TRUE if the trim curves are to be cubic, FALSE otherwise |
| --- | --- | --- |
...
<param name="_CURRENTFILEPATH" value="D:\APIHelp\sw2004\obsoleteapi\Face2\Face2__IGetTrimCurveSize.htm" >
