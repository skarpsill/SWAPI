---
title: "ModelDoc2::FeatureFillet2"
project: ""
interface: ""
member: ""
kind: "topic"
source: "obsoleteapi/ModelDoc2/ModelDoc2__FeatureFillet2.htm"
---

# ModelDoc2::FeatureFillet2

This
method is obsolete and has been superseded by[ModelDoc2::FeatureFillet3](ModelDoc2__FeatureFillet3.htm).
...
retval = ModelDoc2.FeatureFillet2
...
| Return: | (long) retval | 1 if the fillet was created, 0 if not |

Syntax (COM)

status = ModelDoc2->IFeatureFillet2(
...
| Output: | (long) retval | 1 if the fillet was created, 0 if not |
...
<param name="_CURRENTFILEPATH" value="C:\Home\Oneill\sw2003\ModelDoc2\ModelDoc2__FeatureFillet2.htm" >
