---
title: "ModelDoc2::CreatePlaneAtSurface2"
project: ""
interface: ""
member: ""
kind: "topic"
...
the sketch plane normal for a sketch point and a surface, FALSE to project
the sketch plane point normal to the surface |
| Input: | (VARIANT_BOOL) reverseDir | TRUE to create the plane on the opposite side
of the sketch plane, FALSE to not |
| Input: | (VARIANT_BOOL) normalPlane | TRUE to find the plane normal to the surface
...
<param name="_CURRENTFILEPATH" value="C:\Home\obsoleteapi\ModelDoc2\ModelDoc2__CreatePlaneAtSurface2.htm" >
