...
| Output: | (VARIANT_BOOL) retval | TRUE if the sketch hatch was selected, FALSE if not |
...
<param name="_CURRENTFILEPATH" value="D:\APIHelp\sw2004\obsoleteapi\SketchHatch\SketchHatch__Select2.htm" >
...
<param name="ControlLabel" value="See Also" >
<param name="UseIcon" value="0" >
<param name="Items" value="SketchHatch Method$$**$$" >
<param name="Image" value="" >
<param name="FontInfo" value="MS Sans Serif,8,0,," >
<param name="_CURRENTFILEPATH" value="D:\APIHelp\sw2004\obsoleteapi\SketchHatch\SketchHatch__Select2.htm" >
