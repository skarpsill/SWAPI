...
This
method is obsolete and has been superseded by[ModelDoc2::FontUnderline](sldworksAPI.chm::/ModelDoc2/ModelDoc2__FontUnderline.htm).
...
| Input: | (VARIANT_BOOL)underline | TRUE for Underline enabled, FALSE for disabled |
| --- | --- | --- |
...
<param name="_CURRENTFILEPATH" value="D:\APIHelp\sw2004\obsoleteapi\ModelDoc\ModelDoc__FontUnderline.htm" >
