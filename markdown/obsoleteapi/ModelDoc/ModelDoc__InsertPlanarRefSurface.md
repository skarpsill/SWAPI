---
title: "ModelDoc::InsertPlanarRefSurface"
project: ""
interface: ""
member: ""
kind: "topic"
...
This
method is obsolete and has been superseded by[ModelDoc2::InsertPlanarRefSurface](sldworksAPI.chm::/ModelDoc2/ModelDoc2__InsertPlanarRefSurface.htm).
...
| Return: | (BOOL) retval | TRUE if the reference surface was created, FALSE
if not |
| --- | --- | --- |
...
| Output: | (VARIANT_BOOL) retval | TRUE if the reference surface was created, FALSE
if not |
| --- | --- | --- |
...
<param name="_CURRENTFILEPATH" value="D:\APIHelp\sw2003\ModelDoc\ModelDoc__InsertPlanarRefSurface.htm" >
