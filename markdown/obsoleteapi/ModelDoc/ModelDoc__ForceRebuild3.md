...
| Input: | (VARIANT_BOOL) topOnly | TRUE rebuilds top-level assembly only; FALSE rebuilds the top-level
...
<param name="_CURRENTFILEPATH" value="D:\APIHelp\sw2004\obsoleteapi\ModelDoc\ModelDoc__ForceRebuild3.htm" >
