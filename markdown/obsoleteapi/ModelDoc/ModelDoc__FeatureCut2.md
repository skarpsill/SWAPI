...
the sketch. |
| Input: | (VARIANT_BOOL) offsetReverse2 | Iif you chose to offset the second end condition from another face or
plane, then TRUE specifies offset in direction away from the sketch and
FALSE specifies offset from the face or plane in a direction toward the
sketch. |
| Input: | (long) keepPieceIndex | Piece to keep if there is ambiguity |
...
<param name="_CURRENTFILEPATH" value="C:\Home\Oneill\SW2003\ModelDoc\ModelDoc__FeatureCut2.htm" >
