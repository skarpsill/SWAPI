...
| Input: | (ULONG) nSteps | Number of steps to repeat in the active SolidWorks
session |
| --- | --- | --- |
...
clickingEdit, Redoin the SolidWorks
user interface.
...
<param name="_CURRENTFILEPATH" value="D:\APIHelp\sw2003\ModelDoc\ModelDoc__EditRedo.htm" >
