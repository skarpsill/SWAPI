---
title: "EditDimensionProperties Method (ModelDocExtension)"
project: "SOLIDWORKS Type Library"
interface: "ModelDocExtension"
member: "EditDimensionProperties"
kind: "method"
source: "sldworksapivb6/SldWorks~ModelDocExtension~EditDimensionProperties.html"
---

# EditDimensionProperties Method (ModelDocExtension)
...
```vb
Public Function EditDimensionProperties( _
   ...
   ByVal DimensionLowerText As String, _
   ByVal CenterText As Boolean, _
   ByVal ConfigOption As Long, _
   ByVal ConfigNames As Variant _
) As Boolean
```
