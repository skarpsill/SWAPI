---
title: "FeatureExtrusionThin2 Method (FeatureManager)"
project: "SOLIDWORKS Type Library"
interface: "FeatureManager"
member: "FeatureExtrusionThin2"
kind: "method"
source: "sldworksapivb6/SldWorks~FeatureManager~FeatureExtrusionThin2.html"
---

# FeatureExtrusionThin2 Method (FeatureManager)
...
```vb
Public Function FeatureExtrusionThin2( _
   ...
   ByVal RevThinDir As Long, _
   ByVal CapEnds As Long, _
