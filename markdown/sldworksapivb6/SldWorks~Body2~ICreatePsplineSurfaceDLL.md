---
title: "ICreatePsplineSurfaceDLL Method (Body2)"
project: "SOLIDWORKS Type Library"
interface: "Body2"
member: "ICreatePsplineSurfaceDLL"
kind: "method"
source: "sldworksapivb6/SldWorks~Body2~ICreatePsplineSurfaceDLL.html"
---

# ICreatePsplineSurfaceDLL Method (Body2)
...
```vb
Public Function ICreatePsplineSurfaceDLL( _
   ByVal Dim As Long, _
