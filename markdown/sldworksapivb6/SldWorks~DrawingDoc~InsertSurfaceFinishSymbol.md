---
title: "InsertSurfaceFinishSymbol Method (DrawingDoc)"
project: "SOLIDWORKS Type Library"
interface: "DrawingDoc"
member: "InsertSurfaceFinishSymbol"
kind: "method"
source: "sldworksapivb6/SldWorks~DrawingDoc~InsertSurfaceFinishSymbol.html"
---

# InsertSurfaceFinishSymbol Method (DrawingDoc)
...
```vb
Public Function InsertSurfaceFinishSymbol( _
   ByVal SymType As Long, _
   ByVal LeaderType As Long, _
   ByVal LocX As Double, _
   ByVal LocY As Double, _
   ByVal LocZ As Double, _
   ByVal LaySymbol As Long, _
   ByVal ArrowType As Long, _
