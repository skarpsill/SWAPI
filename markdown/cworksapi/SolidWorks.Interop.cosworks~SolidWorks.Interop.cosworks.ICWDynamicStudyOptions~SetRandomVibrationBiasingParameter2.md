---
title: "SetRandomVibrationBiasingParameter2 Method (ICWDynamicStudyOptions)"
project: "SOLIDWORKS Simulation API Help"
interface: "ICWDynamicStudyOptions"
member: "SetRandomVibrationBiasingParameter2"
kind: "method"
source: "cworksapi/SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWDynamicStudyOptions~SetRandomVibrationBiasingParameter2.html"
---

# SetRandomVibrationBiasingParameter2 Method (ICWDynamicStudyOptions)

Sets the biasing parameter of the random vibration dynamic study.
...
```vb
Function SetRandomVibrationBiasingParameter2( _
   ByVal DBiasing As System.Double _
) As System.Integer
```
...
value = instance.SetRandomVibrationBiasingParameter2(DBiasing)
```

### C#

```csharp
System.int SetRandomVibrationBiasingParameter2(
   System.double DBiasing
)
```
...
[CWDynamicStudyOptions::SetRandomVibrationBiasingParameter2](ms-its:cworksapivb6.chm::/CosmosWorksLib~CWDynamicStudyOptions~SetRandomVibrationBiasingParameter2.html)
