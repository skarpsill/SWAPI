---
title: "Add Rigid Connector Example (C#)"
project: ""
interface: ""
member: ""
kind: "example"
source: "cworksapi/Add_Rigid_Connector_Example_CSharp.htm"
---

# Add Rigid Connector Example (C#)
...
```vb
 ...
 namespace AddRigidConnector_CSharp.csproj
 {
     partial class SolidWorksMacro
     {
         ...
         CWRigidConnector rigidConnector;
         CWMesh CwMesh;
         CWResults CWResult;
         string str3;
         string str4;
         ...
         public void Main()
         {
             ...
             // Add rigid connector
             rigidConnector = lrMngr.AddRigidConnector((varArray1), (varArray2), out errCode);
