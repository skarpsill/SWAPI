---
title: "SetRandomVibrationCrossModeCutOffRatio2 Method (ICWDynamicStudyOptions)"
project: "SOLIDWORKS Simulation API Help"
interface: "ICWDynamicStudyOptions"
member: "SetRandomVibrationCrossModeCutOffRatio2"
kind: "method"
source: "cworksapi/SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWDynamicStudyOptions~SetRandomVibrationCrossModeCutOffRatio2.html"
---

# SetRandomVibrationCrossModeCutOffRatio2 Method (ICWDynamicStudyOptions)

Sets the cross-mode cut-off ratio of the random vibration dynamic study.
...
```vb
Function SetRandomVibrationCrossModeCutOffRatio2( _
   ByVal DRatio As System.Double _
) As System.Integer
```
...
value = instance.SetRandomVibrationCrossModeCutOffRatio2(DRatio)
```

### C#

```csharp
System.int SetRandomVibrationCrossModeCutOffRatio2(
   System.double DRatio
)
```
...
- `DRatio`: Cross-mode cut-off ratio
...
[CWDynamicStudyOptions::SetRandomVibrationCrossModeCutOffRatio2](ms-its:cworksapivb6.chm::/CosmosWorksLib~CWDynamicStudyOptions~SetRandomVibrationCrossModeCutOffRatio2.html)
