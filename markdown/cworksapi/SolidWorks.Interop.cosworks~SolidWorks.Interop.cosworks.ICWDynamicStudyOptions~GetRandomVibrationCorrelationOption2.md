---
title: "GetRandomVibrationCorrelationOption2 Method (ICWDynamicStudyOptions)"
project: "SOLIDWORKS Simulation API Help"
interface: "ICWDynamicStudyOptions"
member: "GetRandomVibrationCorrelationOption2"
kind: "method"
source: "cworksapi/SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWDynamicStudyOptions~GetRandomVibrationCorrelationOption2.html"
---

# GetRandomVibrationCorrelationOption2 Method (ICWDynamicStudyOptions)

Gets the correlation type of the random vibration dynamic study.
...
```vb
Function GetRandomVibrationCorrelationOption2( _
   ByRef NCorrelation As System.Integer _
) As System.Integer
```
...
value = instance.GetRandomVibrationCorrelationOption2(NCorrelation)
```

### C#

```csharp
System.int GetRandomVibrationCorrelationOption2(
   out System.int NCorrelation
)
```
...
[CWDynamicStudyOptions::GetRandomVibrationCorrelationOption2](ms-its:cworksapivb6.chm::/CosmosWorksLib~CWDynamicStudyOptions~GetRandomVibrationCorrelationOption2.html)
...
[ICWDynamicStudyOptions::SetRandomVibrationPartialCorrelationDetails Method ()](SolidWorks.Interop.cosworks~SolidWorks.Interop.cosworks.ICWDynamicStudyOptions~SetRandomVibrationPartialCorrelationDetails.html)
