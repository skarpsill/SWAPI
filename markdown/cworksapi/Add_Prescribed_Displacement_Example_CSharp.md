---
title: "Add Prescribed Displacement Example (C#)"
project: ""
interface: ""
member: ""
kind: "example"
source: "cworksapi/Add_Prescribed_Displacement_Example_CSharp.htm"
---

# Add Prescribed Displacement Example (C#)
...
```vb
 ...
 namespace AddPrescribedDisp_CSharp.csproj
 {
     partial class SolidWorksMacro
     {
         ...
         CWRestraint CWFeatObj;
         string strMaterialLib;
         int errCode;
         int longstatus;
         int longwarnings;
         CWStaticStudyOptions StaticOptions;
         object[] DispArray1 = new object[1];
         object[] DispArray2 = new object[6];
         ...
         public void Main()
         {
             ...
             Part = swApp.OpenDoc6("C:\\Users\\Public\\Documents\\SOLIDWORKS\\SOLIDWORKS 2017\\Simulation Examples\\Thermal\\computer_chip.sldasm", (int)swDocumentTypes_e.swDocASSEMBLY, 2, "", ref longstatus, ref longwarnings);
             if (Part == null)
                 ErrorMsg(swApp, "Failed to open computer_chip.sldasm");
             ...
             Study = StudyMngr.CreateNewStudy3("Static_solid_new", (int)swsAnalysisStudyType_e.swsAnalysisStudyTypeStatic, 0, out errCode);
             if (Study == null)
             ...
             longstatus = SolidBody.SetLibraryMaterial(strMaterialLib, "AISI 1020");
             if (longstatus != 1)
             ...
             SolidComp = SolidMgr.GetComponentAt(3, out errCode);
             if (errCode != 0)
                 ErrorMsg(swApp, "Failed to get component");
             SolidBody = SolidComp.GetSolidBodyAt(0, out errCode);
             if (errCode != 0)
             ...
             SolidComp = SolidMgr.GetComponentAt(4, out errCode);
             if (errCode != 0)
                 ErrorMsg(swApp, "Failed to get component");
             SolidBody = SolidComp.GetSolidBodyAt(0, out errCode);
             if (errCode != 0)
             ...
             DispArray2[4] = 1;
             DispArray2[5] = 0;
             CWFeatObj = LBCMgr.AddPrescribedDisplacement((DispArray2), 0, (DispArray1), SelectByPID(Part, "selection7", PIDCollection), out errCode);
             if (errCode != 0)
                 ErrorMsg(swApp, "Failed to create prescribed displacement");
