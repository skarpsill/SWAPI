---
title: "Get DimXpert Tolerance6 Example (C#)"
project: ""
interface: ""
member: ""
kind: "example"
...
// kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}d. Click a back face of the part.
// kadov_tag{{<spaces>}}   e. Click outside the part to place Datum B.
// kadov_tag{{<spaces>}}   f. Click a side face of the part.
// kadov_tag{{<spaces>}}   g. Click outside the part to place Datum C.
// kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}h. Click Geometric Tolerance on the DimXpert toolbar.
// kadov_tag{{<spaces>}}      kadov_tag{{</spaces>}}In the Geometric Tolerance Properties dialog:
// kadov_tag{{<spaces>}}      i.    Select Profile of Surface from the Symbol dropdown list.
//       ii.   Type  50 in Tolerance 1.
// kadov_tag{{<spaces>}}      iii.  Type A in the Primary box and C in the
//             Secondary box.
...
// kadov_tag{{<spaces>}}      kadov_tag{{</spaces>}} vi.   In the second row, type A in the Primary box.
// kadov_tag{{<spaces>}}      vii.  Select the Composite frame check box.
...
// kadov_tag{{<spaces>}}      kadov_tag{{</spaces>}}x.    Click OK to close the Geometric Tolerance
//             Properties dialog.
// kadov_tag{{<spaces>}}   i. In the DimXpertManager tab of the Management Panel,
//       expand Cylinder1.
// kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}j. Observe the following DimXpert annotation: kadov_tag{{<spaces>}} kadov_tag{{</spaces>}}
//       Surface Profile1 and Surface Profile2
// kadov_tag{{<spaces>}}4. Create tangency tolerances:
// kadov_tag{{<spaces>}}   a. Click Auto Dimension Scheme on the DimXpert toolbar.
// kadov_tag{{<spaces>}}   b. Select all feature filters.
// kadov_tag{{<spaces>}}   c. Click the green check mark to accept the settings.
// kadov_tag{{<spaces>}}   d. Observe several tangency tolerance annotations.
...
//          file name.
//kadov_tag{{<spaces>}} 6. Read how to load and run Code_Example_CSharp with this part.
 //--------------------------------------------------------------------------
```
