---
title: "ISwDMDocument15 Interface Methods"
project: "SOLIDWORKS Document Manager API Help"
interface: "ISwDMDocument15_methods"
member: ""
kind: "methods"
source: "swdocmgrapi/SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument15_methods.html"
---

# ISwDMDocument15 Interface Methods

For a list of all members of this type, see[ISwDMDocument15 members](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument15_members.html).

## Public Methods

|  | Name | Description |
| --- | --- | --- |
| Method | GetExternalFeatureReferences | Obsolete. Superseded by ISwDMDocument18::GetExternalFeatureReferences2 . |
| Method | GetPartNumberStreamFile | Gets the name of the XML file generated when uploading a model to 3D Content Central . The XML file is only generated if the model has a design table with a part number column. |
