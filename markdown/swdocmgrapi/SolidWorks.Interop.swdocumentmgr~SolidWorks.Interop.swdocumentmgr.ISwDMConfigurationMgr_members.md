---
title: "ISwDMConfigurationMgr Interface Members"
project: "SOLIDWORKS Document Manager API Help"
interface: "ISwDMConfigurationMgr_members"
member: ""
kind: "members"
source: "swdocmgrapi/SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfigurationMgr_members.html"
---

# ISwDMConfigurationMgr Interface Members

The following tables list the members exposed by[ISwDMConfigurationMgr](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfigurationMgr.html).

## Public Properties

|  | Name | Description |
| --- | --- | --- |
| Property | Application | Gets the ISwDMApplication object. |
| Property | Document | Gets the ISwDMDocument object for this document. |
...
|  | Name | Description |
| --- | --- | --- |
| Method | GetActiveConfigurationName | Gets the name of the active configuration in the document. |
| Method | GetConfigurationByName | Obsolete. Superseded by ISwDMConfigurationMgr2::GetConfigurationByName2 . |
| Method | GetConfigurationCount | Obsolete. Superseded by ISwDMConfigurationMgr2::GetConfigurationCount2 . |
| Method | GetConfigurationNames | Obsolete. Superseded by ISwDMConfigurationMgr2::GetConfigurationNames2 . |
...
[ISwDMConfiguration13 Interface](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration13.html)
