---
title: "ISwDMConfiguration7 Interface Members"
project: "SOLIDWORKS Document Manager API Help"
interface: "ISwDMConfiguration7_members"
member: ""
kind: "members"
source: "swdocmgrapi/SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration7_members.html"
---

# ISwDMConfiguration7 Interface Members

The following tables list the members exposed by[ISwDMConfiguration7](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration7.html).

## Public Properties

|  | Name | Description |
| --- | --- | --- |
| Property | AlternateName2 | Gets or sets the user-specified name of the configuration. |
| Property | Comment2 | Gets or sets the comment for the configuration. |
| Property | Delete | Gets or sets whether to mark this configuration as deleted. |
| Property | Name2 | Gets or sets the name of the configuration . |
| Property | PreviewPNGStreamName | Gets the name of the stream for the PNG preview bitmap of this configuration. |
...
|  | Name | Description |
| --- | --- | --- |
| Method | GetPreviewPNGBitmap | Gets the PNG preview bitmap for this configuration. |
