---
title: "ISwDMConfiguration2 Interface Methods"
project: "SOLIDWORKS Document Manager API Help"
interface: "ISwDMConfiguration2_methods"
member: ""
kind: "methods"
source: "swdocmgrapi/SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration2_methods.html"
---

# ISwDMConfiguration2 Interface Methods

For a list of all members of this type, see[ISwDMConfiguration2 members](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration2_members.html).

## Public Methods

|  | Name | Description |
| --- | --- | --- |
| Method | GetComponents | Gets the components referenced by the configuration. |
| Method | GetPartitionStream | Gets the Parasolid partition stream that has the body partition information and writes it the specified file. Supports part documents only. |
