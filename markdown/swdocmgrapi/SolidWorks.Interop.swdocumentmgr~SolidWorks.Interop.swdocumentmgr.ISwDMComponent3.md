---
title: "ISwDMComponent3 Interface"
project: "SOLIDWORKS Document Manager API Help"
interface: "ISwDMComponent3"
member: ""
kind: "interface"
source: "swdocmgrapi/SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMComponent3.html"
---
...
[SwDMComponent3](ms-its:swdocmgrapivb6.chm::/swdocumentmgr~SwDMComponent3.html)
...
- You can access an ISwDMComponent3 object by calling QueryInterface on an[ISwDMComponent](SOLIDWORKS.Interop.swdocumentmgr~SOLIDWORKS.Interop.swdocumentmgr.ISwDMComponent.html)object in C++ or by direct assignment in Visual Basic.
- The ISwDMComponent object can be assigned to an ISwDMComponent3 variable, just like the SOLIDWORKS[IModelDoc2](ms-its:sldworksapi.chm::/SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IModelDoc2.html)object can be assigned to a SOLIDWORKS[IPartDoc](ms-its:sldworksapi.chm::/SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IPartDoc.html)variable.
