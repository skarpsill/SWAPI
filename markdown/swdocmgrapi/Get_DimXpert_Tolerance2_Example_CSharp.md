---
title: "Get DimXpert Tolerance2 Example (C#)"
project: ""
interface: ""
member: ""
kind: "example"
source: "swdocmgrapi/Get_DimXpert_Tolerance2_Example_CSharp.htm"
---

# Get DimXpert Tolerance2 Example (C#)
...
// kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}3. Create a distance-between dimension tolerance:
...
//kadov_tag{{<spaces>}}    kadov_tag{{</spaces>}} c. Click Create Compound Plane on the DimXpert pop-up toolbar.
// kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}d. Click the right front face of the block.
//kadov_tag{{<spaces>}}    e. Click the green check mark to accept the faces.
...
// kadov_tag{{<spaces>}}   h. Click ESC to end dimensioning.
...
// kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}d. Click in the Primary Datum field; select face in front of
//       right hole.
...
// kadov_tag{{<spaces>}}   g. Click the green check mark to accept the DimXpert settings.
// kadov_tag{{<spaces>}}   h. Observe the following DimXpert annotations: kadov_tag{{<spaces>}} kadov_tag{{</spaces>}}Diameter1,
//       DistanceBetween5, Radius1.
// kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}5. Create a symmetry geometric tolerance:
// kadov_tag{{<spaces>}}   a. Click Datum on the DimXpert toolbar.
//kadov_tag{{<spaces>}}    b. Click the face in front of the left hole and click
//       outside the part to place Datum A.
// kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}c. Click the green check mark to finish the Datum definition.
// kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}d. Click Geometric Tolerance on the DimXpert toolbar.
// kadov_tag{{<spaces>}}      kadov_tag{{</spaces>}}In the Geometric Tolerance Properties dialog:
// kadov_tag{{<spaces>}}      i.   Select Symmetry from the Symbol dropdown list.
...
// kadov_tag{{<spaces>}}      v.   Click OK to close the Geometric Tolerance Properties dialog.
//kadov_tag{{<spaces>}}    e. Observe the following DimXpert annotations: kadov_tag{{</spaces>}}Symmetry1.
