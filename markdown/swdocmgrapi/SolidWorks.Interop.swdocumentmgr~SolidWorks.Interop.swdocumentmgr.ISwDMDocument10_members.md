---
title: "ISwDMDocument10 Interface Members"
project: "SOLIDWORKS Document Manager API Help"
interface: "ISwDMDocument10_members"
member: ""
kind: "members"
source: "swdocmgrapi/SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument10_members.html"
---

# ISwDMDocument10 Interface Members

The following tables list the members exposed by[ISwDMDocument10](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument10.html).

## Public Properties

|  | Name | Description |
| --- | --- | --- |
| Property | PreviewPNGStreamName | Gets the name of the stream for the preview bitmap (.png) of this document. |
| Property | PreviewStreamName | Gets the name of the stream for the preview bitmap (.bmp) of this configuration. |
...
|  | Name | Description |
| --- | --- | --- |
| Method | GetPreviewBitmap | Gets the preview bitmap (.bmp) for this document. |
| Method | GetPreviewPNGBitmap | Gets the PNG preview bitmap (.png) for this document. |
| Method | GetSheets | Gets the sheets in a drawing document. |
| Method | GetTable | Gets the specified table. |
| Method | GetTableNames | Gets the names of the tables in this document. |
| Method | GetViews | Gets the views in this document. |
