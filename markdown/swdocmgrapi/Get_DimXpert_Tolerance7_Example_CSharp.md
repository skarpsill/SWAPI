---
title: "Get DimXpert Tolerance7 Example (C#)"
project: ""
interface: ""
member: ""
kind: "example"
source: "swdocmgrapi/Get_DimXpert_Tolerance7_Example_CSharp.htm"
---

# Get DimXpert Tolerance7 Example (C#)
...
// kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}4. Create the line profile geometric tolerance:
...
// kadov_tag{{<spaces>}}   NOTE: Because these parts are used in a SOLIDWORKS online
//         tutorial, do not save any changes to the original
//         file name.
// kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}6. Read how to load and run Code_Example_CSharp with this part.
 //-----------------------------------------------------------------------------
```
