---
title: "ISwDMDocument14 Interface Methods"
project: "SOLIDWORKS Document Manager API Help"
interface: "ISwDMDocument14_methods"
member: ""
kind: "methods"
source: "swdocmgrapi/SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument14_methods.html"
---

# ISwDMDocument14 Interface Methods

For a list of all members of this type, see[ISwDMDocument14 members](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument14_members.html).

## Public Methods

|  | Name | Description |
| --- | --- | --- |
| Method | Get3DCCGenericStreamFile | Exports an XML file with the 3D Content Central (3DCC) generic format configuration rules that were built into this document by the SOLIDWORKS Configuration Publisher. |
| Method | Get3DCCStreamFile | Exports an XML file with the 3D Content Central (3DCC) original format configuration rules built into this document by the SOLIDWORKS Configuration Publisher. |
