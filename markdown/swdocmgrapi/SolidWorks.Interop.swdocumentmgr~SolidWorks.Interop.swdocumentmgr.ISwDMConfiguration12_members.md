---
title: "ISwDMConfiguration12 Interface Members"
project: "SOLIDWORKS Document Manager API Help"
interface: "ISwDMConfiguration12_members"
member: ""
kind: "members"
source: "swdocmgrapi/SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration12_members.html"
---

# ISwDMConfiguration12 Interface Members

The following tables list the members exposed by[ISwDMConfiguration12](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMConfiguration12.html).

## Public Properties

|  | Name | Description |
| --- | --- | --- |
| Property | DimXpertPart | Gets the DimXpert part associated with this configuration. |
...
|  | Name | Description |
| --- | --- | --- |
| Method | GetComponentVisibleByDisplayStateName | Gets the visibility states and path and file names of the components in the given display state. |
| Method | GetID | Gets the ID of the configuration. |
| Method | GetLinkedDisplayStates | Gets the names and number of linked display states. |
