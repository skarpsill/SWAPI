...
member: ""
kind: "example"
source: "swdocmgrapi/Get_DimXpert_Tolerance4_Example_VBNET.htm"
---
...
' kadov_tag{{<spaces>}}   c. Click the green arrow to accept the settings.
...
' kadov_tag{{<spaces>}}   b. Click a face of the part.
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}c. Click a face perpendicular to the face
'       selected in step 2 (not the chamfer).
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}d. Click outside the part to place the annotation.
' kadov_tag{{<spaces>}}   e. Find the following in the DimXpert tree: kadov_tag{{</spaces>}}AngleBetween1.
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}5. Create line profile and straightness geometric tolerances:
...
' kadov_tag{{<spaces>}}      kadov_tag{{</spaces>}}i.   Select Straightness from the Symbol dropdown
'            list.
' kadov_tag{{<spaces>}}      ii.  In second row, select Profile of Line from
'            the Symbol dropdown list.
' kadov_tag{{<spaces>}}      iii. Type 0.25 in Tolerance1.
' kadov_tag{{<spaces>}}      kadov_tag{{</spaces>}}iv.  Click the top face of the part.
' kadov_tag{{<spaces>}}      kadov_tag{{</spaces>}}v.   Click outside the part to place the
'            annotation.
' kadov_tag{{<spaces>}}      vi.  Click OK to close the Geometric Tolerance
'            Properties dialog.
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}b. Observe the following DimXpert annotations: kadov_tag{{<spaces>}} kadov_tag{{</spaces>}}
