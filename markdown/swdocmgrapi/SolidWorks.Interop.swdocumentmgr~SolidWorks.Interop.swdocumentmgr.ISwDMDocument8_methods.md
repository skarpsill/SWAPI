---
title: "ISwDMDocument8 Interface Methods"
project: "SOLIDWORKS Document Manager API Help"
interface: "ISwDMDocument8_methods"
member: ""
kind: "methods"
source: "swdocmgrapi/SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument8_methods.html"
---

# ISwDMDocument8 Interface Methods

For a list of all members of this type, see[ISwDMDocument8 members](SolidWorks.Interop.swdocumentmgr~SolidWorks.Interop.swdocumentmgr.ISwDMDocument8_members.html).

## Public Methods

|  | Name | Description |
| --- | --- | --- |
| Method | GetChangedReferences | Gets a list of the names of the original references and their corresponding new references if the references were changed using the SOLIDWORKS Document Manager API or SOLIDWORKS Explorer. |
| Method | GetComponentCount | Gets the number of components in a SOLIDWORKS assembly document. |
