---
title: "Get DimXpert Tolerance8 Example (VB.NET)"
project: ""
interface: ""
member: ""
kind: "example"
...
```vb
 '-----------------------------------------------------------------------------
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}1. Open public_documents\samples\tutorial\api\cover_datum.sldprt.
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}2. Click Datum on the DimXpert toolbar and place
'    Datum A inside the hole.
' kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}3. Create the circular runout geometric tolerance:
...
' kadov_tag{{<spaces>}}      i.  Select Circular Runout from the Symbol dropdown
'           list in the first row.
' kadov_tag{{<spaces>}}      kadov_tag{{</spaces>}}ii.  In the Primary field, type A.
...
'            Properties dialog.
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}b. Observe CircularRunout1 under Cylinder1 in the
'       DimXpert tree.
...
'            Properties dialog.
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}b. Observe TotalRunout1 under Boss1 in the DimXpert
'       tree.
' kadov_tag{{<spaces>}}5. Create the angularity geometric tolerance:
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}a. Click Geometric Tolerance on the DimXpert toolbar.
' kadov_tag{{<spaces>}}      In the Geometric Tolerance Properties dialog:
' kadov_tag{{<spaces>}}      kadov_tag{{</spaces>}}i.   Select Angularity from the Symbol dropdown
'            in the first row.
' kadov_tag{{<spaces>}}      ii.  In the Primary field, type A.
' kadov_tag{{<spaces>}}      kadov_tag{{</spaces>}} iii. Click a face of the notch and click again
...
'       tree.
' kadov_tag{{<spaces>}}6. Create the parallelism geometric tolerance:
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}a. Click Geometric Tolerance on the DimXpert toolbar.
' kadov_tag{{<spaces>}}      In the Geometric Tolerance Properties dialog:
' kadov_tag{{<spaces>}}      kadov_tag{{</spaces>}}i.   Select Parallel from the Symbol dropdown
'            in the first row.
' kadov_tag{{<spaces>}}      ii.  In the Primary field, type A.
' kadov_tag{{<spaces>}}      kadov_tag{{</spaces>}}iii. Click the boss of the part and click again
' kadov_tag{{<spaces>}}        kadov_tag{{</spaces>}}   outside the part to place the annotation.
' kadov_tag{{<spaces>}}      kadov_tag{{</spaces>}}iv.  Click OK to close the Geometric Tolerance
'            Properties dialog.
' kadov_tag{{<spaces>}}   kadov_tag{{</spaces>}}b. Observe Parallelism1 under Boss1 in the DimXpert tree.
...
'           file name.
' kadov_tag{{<spaces>}}8. Read how to load and run Code_Example_VBNET with this part.
 '-----------------------------------------------------------------------------
```
