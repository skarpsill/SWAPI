---
title: "IEdmUserMgr8 Interface"
project: "SOLIDWORKS PDM Professional API Help"
interface: "IEdmUserMgr8"
member: ""
kind: "interface"
source: "API_GB/EPDM.Interop.epdm~EPDM.Interop.epdm.IEdmUserMgr8.html"
---
...
Public Interface IEdmUserMgr8
   Inherits IEdmUserMgr5, IEdmUserMgr6, IEdmUserMgr7
```
...
[Create User Picture (VB.NET)](Create_User_Picture_Example_VBNET.htm)

[Create User Picture (C#)](Create_User_Picture_Example_CSharp.htm)
...
- extends
  ...
  by providing the ability to display a user's picture and a popup with picture information.
- is extended by
