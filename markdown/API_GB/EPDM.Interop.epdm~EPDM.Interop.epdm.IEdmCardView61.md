---
title: "IEdmCardView61 Interface"
project: "SOLIDWORKS PDM Professional API Help"
interface: "IEdmCardView61"
member: ""
kind: "interface"
source: "API_GB/EPDM.Interop.epdm~EPDM.Interop.epdm.IEdmCardView61.html"
---
...
Public Interface IEdmCardView61
   Inherits IEdmCardView5, IEdmCardView6
```

### C#

```csharp
public interface IEdmCardView61 : IEdmCardView5, IEdmCardView6
```

### C++/CLI

```cpp
public interface class IEdmCardView61 : public IEdmCardView5, IEdmCardView6
```
...
- extends
  ...
  by adding the ability to set input focus to a certain control in the card view.
- is extended by
