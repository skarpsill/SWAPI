---
title: "api/{vaultName}/users (Get)"
project: ""
interface: "r-api-{vaultName}-users"
member: "o-HttpGet"
kind: "topic"
source: "pdmprowebapihelp/PDM Pro API_ws~r-api-{vaultName}-users~o-HttpGet.html"
---

# api/{vaultName}/users (Get)

PDM Pro API Web Service

| Get | api/{vaultName}/users |
| --- | --- |
...
| PDM Pro API Web Service > User Resource Group : api/{vaultName}/users (Get) |
| --- |
