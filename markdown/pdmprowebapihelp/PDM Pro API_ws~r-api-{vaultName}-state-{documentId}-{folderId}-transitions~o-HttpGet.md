---
title: "api/{vaultName}/state/{documentId}/{folderId}/transitions (Get)"
project: ""
interface: "r-api-{vaultName}-state-{documentId}-{folderId}-transitions"
member: "o-HttpGet"
kind: "topic"
source: "pdmprowebapihelp/PDM Pro API_ws~r-api-{vaultName}-state-{documentId}-{folderId}-transitions~o-HttpGet.html"
---

# api/{vaultName}/state/{documentId}/{folderId}/transitions (Get)

PDM Pro API Web Service

| Get | api/{vaultName}/state/{documentId}/{folderId}/transitions |
| --- | --- |
...
| PDM Pro API Web Service > State Transition Resource Group : api/{vaultName}/state/{documentId}/{folderId}/transitions (Get) |
| --- |
