---
title: "SetSettingsVar Method (IEdmUserGroup9)"
...
- `eVar`: User group setting as defined by

[EdmGroupSetting](EPDM.Interop.epdm~EPDM.Interop.epdm.EdmGroupSetting.html)
